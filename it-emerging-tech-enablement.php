<?php $pageTitle = "IT & Emerging Tech Enablement";
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <section id="home" class="rs-banner-area rs-banner-one">
            <div class="rs-banner-bg-thumb include-bg" data-background="assets/images/solution/it-emerging.webp"></div>
                        ...
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content-wrapper">
                                ...
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">
                                    Modern IT Ecosystems &amp; <br><span id="demo-typed-text" style="color:#AB052D;"></span><span class="demo-typed-cursor" style="color:#AB052D; font-weight:300;">|</span>
                                </h1>
                                <span class="rs-banner-line"></span>
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">Future-proof your operations with our expertise in software development, IoT, RFID solutions, and strategic digital transformation.</p>
        ...
        <script>
        (function() {
            var text = "Digital Transformation Enablement";
