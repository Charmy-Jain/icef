<?php $pageTitle = "Industry We Works With & Clientele";
...
<body class="rs-smoother-yes">
    ...
    <main>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9 col-lg-10">
                        <div class="section-title-wrapper text-center section-title-space">
                            ...
                            <p class="section-desc">Position your agency as the bridge between a client’s big-picture
                                vision
                                and achievable
                            </p>
                        </div>
        ...
        <section id="clients" class="rs-testimonial-area rs-testimonial-four section-space rs-swiper"
            style="padding-top: 50px; margin-bottom: 200px; scroll-margin-top: 90px;">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-8">
                        <div class="section-title-wrapper section-title-space text-center">
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left is-white">Testimonials that
                                inspire
                                trust
                            </h2>
                        </div>
                    ...
                    <div class="col-xl-12">
                        <div class="rs-testimonial-slider-wrapper">
                            <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="1500"
                                ...
                                data-effect="false" data-delay="2000" data-item="3" data-item-xl="3" data-item-lg="2"
                                data-item-md="2" data-item-sm="1" data-item-xs="1" data-margin="30">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="rs-testimonial-item">
                                            ...
                                            <p class="rs-testimonial-desc"> Outstanding support and expertise! Our
                                                startup
                                                achieved significant growth thanks to their guidance. Truly
                                                professional.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-testimonial-item">
                                            ...
                                            <p class="rs-testimonial-desc"> We believe that every business is uniquids
                                                our
                                                approach never one size fits all. We tailor our strategies to fit your
                                                goals is
                                                and industry.
                                            </p>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rs-testimonial-item">
                                            ...
                                            <p class="rs-testimonial-desc"> Professional, knowledgeable, and responsive.
                                                Their
