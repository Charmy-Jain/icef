<?php $pageTitle = "Recruitment Assessments";
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <section id="home" class="rs-banner-area rs-banner-one">
            <div class="rs-banner-bg-thumb include-bg" data-background="assets/images/about/37.webp"></div>
                        ...
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content-wrapper">
                                ...
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s" >
                                    Recruitment Assessments & &amp; <br><span id="demo-typed-text" style="color:#AB052D;"></span><span class="demo-typed-cursor" style="color:#AB052D; font-weight:300;">|</span>
                                </h1>
                                <span class="rs-banner-line"></span>
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">Objective evaluation methodologies to measure candidate potential and cultural fit for your organizational success.</p>
                        ...
                        <div class="rs-banner-thumb rs-banner-form-wrap wow fadeInRight" data-wow-delay="1.1s" data-wow-duration="1.3s">
                            <div class="rs-banner-contact-form" style="padding: 24px;">
                                ...
                                <?php 
                                    ...
                                    $selected_sub_service = "assessments";
