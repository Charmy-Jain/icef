<?php $pageTitle = "Call Center & BPOs";
                        ...
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content">
                                <span class="rs-banner-subtitle wow fadeInUp" data-wow-delay=".3s"
                                    ...
                                    Voices That Represent Excellence
                                </span>
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">
                                    Next-Gen Omnichannel BPO & Support Solutions
                                </h1>
                                <span class="rs-banner-line"></span>
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">Empower your customer relationships with our high-performance support teams and state-of-the-art contact center technology.</p>
                            ...
                            <div class="rs-banner-thumb rs-banner-form-wrap wow fadeInRight" data-wow-delay="1.1s" data-wow-duration="1.3s">
                                ...
                                <img src="assets/images/banner/call-center.webp" alt="image" class="rs-banner-bg-img">
                                <div class="rs-banner-contact-form">
                                    ...
                                    <form action="#" method="POST" class="rs-contact-form-banner">
                                        ...
                                        <div class="rs-form-row">
                                            <div class="rs-form-group">
                                                <select name="service">
                                                    <option value="" disabled selected>BPO Domain</option>
                                                    <option value="inbound">Inbound Support</option>
                                                    <option value="outbound">Outbound Telesales</option>
                                                    <option value="technical">Technical Helpdesk</option>
                                                    <option value="backoffice">Back Office Ops</option>
                                                </select>
                                            </div>
                                            <div class="rs-form-group">
                                                <select name="sub_service">
                                                    <option value="" disabled selected>Channel Preference</option>
                                                    <option value="voice">Voice Only</option>
                                                    <option value="non_voice">Non-Voice (Chat/Email)</option>
                                                    <option value="omnichannel">Omnichannel (All)</option>
                                                    <option value="self_service">Self-Service AI</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="rs-form-row">
                                ...
                                <div class="rs-banner-feature">
                                    <div class="rs-banner-feature-inner">
                                        <div class="rs-banner-feature-thumb">
                                            <img src="assets/images/banner/call-center.webp" alt="image">
                                        </div>
                                        <div class="rs-banner-feature-content">
                                            <h5 class="rs-banner-feature-title">24/7 Customer Care</h5>
                                            <p class="rs-banner-feature-desc">Delivering world-class support across multiple channels with focus on CSAT.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9 col-lg-10">
                        <div class="section-title-wrapper text-center section-title-space">
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left mb-15">Omnichannel Customer Support
                            </h2>
                            <p class="section-desc">Elevate your brand with our world-class BPO solutions. From inbound support to outbound operations, we provide the voice that represents your business excellence.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-feature-wrapper wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <?php
                            $features = [
                                ["thumb" => "05", "title" => "Inbound Customer Support"],
                                ["thumb" => "06", "title" => "Outbound Telesales"],
                                ["thumb" => "07", "title" => "Technical Helpdesk"],
                                ["thumb" => "08", "title" => "Chat & Email Support"],
                                ["thumb" => "09", "title" => "Lead Generation"],
                                ["thumb" => "13", "title" => "Market Research"],
                                ["thumb" => "14", "title" => "Back Office BPO"],
                                ["thumb" => "10", "title" => "E-commerce Support"],
                                ["thumb" => "15", "title" => "Loyalty Programs"],
                                ["thumb" => "16", "title" => "Collections Services"],
                                ["thumb" => "17", "title" => "Omnichannel Solutions"],
                                ["thumb" => "11", "title" => "Global Voice Services"],
                                ["thumb" => "12", "title" => "Data Entry Services"]
                            ];
                        ...
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-content-wrapper">
                                <div class="section-title-wrapper">
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left is-white mb-20">Your Partner in Customer Success and Engagement</h2>
                                    <p class="section-desc is-white">ICEF India provides comprehensive BPO and call center services tailored to the modern digital era. Our state-of-the-art facilities and trained professionals ensure that every interaction adds value to your customers and growth to your enterprise.</p>
                                </div>
                        ...
                        <div class="rs-working-wrapper">
                            <div class="rs-working-content-wrapper">
                                <div class="section-title-wrapper">
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-20">Transforming interactions into long-term loyalty</h2>
                                    <p class="rs-section-desc">We combine advanced telephony technology with empathetic human touch. Our strategy focuses on reducing turnaround times and increasing customer satisfaction scores through continuous monitoring and improvement.</p>
                                </div>
