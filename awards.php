<?php $pageTitle = "Awards & Recognition";
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <!-- brand area start -->
        <div class="rs-brand-area rs-brand-three" style="padding-top: 60px; padding-bottom: 60px;">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
        ...
        <!-- Section 4: Transforming Strategy (Growth Section) -->
                    ...
                    <div class="col-xl-12">
                        <div class="rs-working-wrapper">
                            <div class="rs-working-content-wrapper">
                                ...
                                <div class="rs-about-progress-wrapper mt-30">
                                    <div class="rs-progress-wrapper">
                                        ...
                                        <div class="rs-progress-item-wrapper">
                                            <div class="single-progress mb-4">
                                                <div class="progress-top d-flex justify-content-between mb-2">
                                                ...
                                                <div class="progress" style="height: 10px;">
                                                    <div class="progress-bar wow fadeInLeft" data-wow-duration="1s"
                                                        ...
                                                        style="width: 95%; background-color: var(--rs-theme-primary);"
                                            ...
                                            <div class="single-progress">
                                                ...
                                                <div class="progress" style="height: 10px;">
                                                    <div class="progress-bar wow fadeInLeft" data-wow-duration="1s"
                                                        ...
                                                        style="width: 90%; background-color: var(--rs-theme-secondary);"
        ...
        <section class="rs-testimonial-area section-space rs-testimonial-two rs-swiper">
            ...
            <div class="container">
                <div class="row align-items-center g-5 section-title-space">
                    ...
                    <div class="col-xl-6 col-lg-5 text-end">
                        <!-- Navigation -->
                        <div class="rs-testimonial-navigation rs-swiper-btn-wrapper justify-content-end">
                            ...
                            <div class="rs-faq-right">
                                <div class="rs-faq-content rs-accordion-one">
                                    <div class="accordion-wrapper">
                                        <div class="accordion" id="accordionFaqAwards">
                                            <div class="rs-accordion-item has-bg-active active">
                                                ...
                                                <div id="faqCollapseOne" class="accordion-collapse collapse show"
                                                    data-bs-parent="#accordionFaqAwards">
                                            ...
                                            <div class="rs-accordion-item has-bg-active">
                                                <h6 class="accordion-header" id="faqHeadingThree">
                                                    <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="rs-accordion-item has-bg-active">
                                                <h6 class="accordion-header" id="faqHeadingFour">
                                                    <button class="accordion-button collapsed" type="button"
