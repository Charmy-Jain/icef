<?php $pageTitle = "Emerging Tech Integration";
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <section id="home" class="rs-banner-area rs-banner-one">
            <div class="rs-banner-bg-thumb include-bg" data-background="assets/images/solution/emerging-tech.webp"></div>
                    ...
                    <div class="col-xxl-6 col-xl-7 col-lg-7">
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content-wrapper">
                                ...
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">Integrate the latest advancements in AI, machine learning, and blockchain into your core business architecture.</p>
        ...
        <script>
        (function() {
            var text = "Advanced Tech Implementations";
