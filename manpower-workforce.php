<?php $pageTitle = "Manpower & Workforce";
                        ...
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content">
                                ...
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">
                                    Strategic Manpower & Workforce Management Solutions
                                </h1>
                                <span class="rs-banner-line"></span>
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">Build and manage high-performing teams with our end-to-end recruitment, training, and deployment services tailored for your industry.</p>
                            ...
                            <div class="rs-banner-thumb rs-banner-form-wrap wow fadeInRight" data-wow-delay="1.1s" data-wow-duration="1.3s">
                                ...
                                <img src="assets/images/banner/manpower.webp" alt="image" class="rs-banner-bg-img">
                                <div class="rs-banner-contact-form">
                                    ...
                                    <form action="#" method="POST" class="rs-contact-form-banner">
                                        ...
                                        <div class="rs-form-row">
                                            <div class="rs-form-group">
                                                <select name="service">
                                                    <option value="" disabled selected>Workforce Solution</option>
                                                    <option value="permanent">Permanent Staffing</option>
                                                    <option value="temporary">Contract/Temp Staffing</option>
                                            ...
                                            <div class="rs-form-group">
                                                <select name="sub_service">
                                                    <option value="" disabled selected>Industry Domain</option>
                                ...
                                <div class="rs-banner-feature">
                                    <div class="rs-banner-feature-inner">
                                        <div class="rs-banner-feature-thumb">
                                            <img src="assets/images/banner/manpower.webp" alt="image">
                                        </div>
                                        <div class="rs-banner-feature-content">
                                            <h5 class="rs-banner-feature-title">Elite Talent Search</h5>
                                            <p class="rs-banner-feature-desc">Connecting you with the industry's best professionals to fuel your business growth.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9 col-lg-10">
                        <div class="section-title-wrapper text-center section-title-space">
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left mb-15">Scalable Manpower Management
                            </h2>
                            <p class="section-desc">Optimize your human resources with our comprehensive manpower solutions. We provide the right talent at the right time to keep your operations running smoothly.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-feature-wrapper wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <?php
                            $features = [
                                ["thumb" => "05", "title" => "Permanent Staffing"],
                                ["thumb" => "06", "title" => "Temporary Staffing"],
                                ["thumb" => "07", "title" => "Executive Search"],
                                ["thumb" => "08", "title" => "Payroll Outsourcing"],
                                ["thumb" => "09", "title" => "Contract Staffing"],
                                ["thumb" => "13", "title" => "Campus Recruitment"],
                                ["thumb" => "14", "title" => "HR Consulting"],
                                ["thumb" => "10", "title" => "Workforce Training"],
                                ["thumb" => "15", "title" => "Regulatory Compliance"],
                                ["thumb" => "16", "title" => "Labor Management"],
                                ["thumb" => "17", "title" => "Security Staffing"],
                                ["thumb" => "11", "title" => "Industrial Manpower"],
                                ["thumb" => "12", "title" => "Technical Staffing"]
                            ];
                        ...
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-content-wrapper">
                                <div class="section-title-wrapper">
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left is-white mb-20">Building Productive Teams for Sustainable Growth</h2>
                                    <p class="section-desc is-white">ICEF India is committed to delivering excellence in workforce management. We specialize in identifying, training, and deploying skilled manpower that aligns perfectly with your organizational values and operational requirements.</p>
                                </div>
                        ...
                        <div class="rs-working-wrapper">
                            <div class="rs-working-content-wrapper">
                                <div class="section-title-wrapper">
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-20">Managing human capital with precision and care</h2>
                                    <p class="rs-section-desc">Our manpower consulting helps you navigate the complexities of labor management, compliance, and talent retention. We provide data-backed insights to improve workforce productivity and operational efficiency.</p>
                                </div>
