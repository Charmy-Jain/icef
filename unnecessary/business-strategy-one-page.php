<?php $pageTitle = "Business Strategy One Page"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-three rs-swiper">
            <div class="container-fluid g-0">
                <div class="row g-0">
                    <div class="col-xl-12">
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content-wrapper">
                                <div class="rs-banner-content-inner">
                                    <div class="rs-banner-shape">
                                        <img src="assets/images/shape/banner-shape-01.webp" alt="image">
                                    </div>
                                    <span class="rs-banner-subtitle wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".5s">
                              Affordable Effective Reliable
                           </span>
                                    <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">Strategic Growth For Modern Businesses
                                    </h1>
                                    <span class="rs-banner-line"></span>
                                    <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">we believe that every business is uniquids our approach is
                                    ...
                                    <div class="rs-banner-btn wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1.1s">
                                        <a class="rs-btn has-icon has-bg-white hover-primary" href="contact.php">Free
                                            Consultation
                                            <span class="icon-box">
                                ...
                                <div class="rs-banner-brand">
                                    <div class="rs-brand-area rs-brand-two">
                                        <div class="brand-slider">
                                            <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-center-mode="false" data-effect="false" data-no-gap="true" data-delay="1500" data-item="3" data-item-xl="2" data-item-lg="2" data-item-md="3" data-item-sm="2" data-item-xs="2" data-item-mobile="1">
                            ...
                            <div class="rs-banner-thumb">
                                <img src="assets/images/banner/banner-thumb-03.webp" alt="">
                                <div class="rs-banner-feature">
                                    ...
                                    <div class="rs-banner-feature-content">
                                        ...
                                        <div class="rs-banner-feature-btn">
                                            <a href="services.php" class="rs-square-btn has-icon has-transparent is-white">
                                                <span class="icon-box">
        ...
        <!-- about area start -->
        <section id="about" class="rs-about-area rs-about-three section-space">
            <div class="rs-shape-one">
                <img src="assets/images/shape/apartment-shape.webp" alt="image">
            </div>
            <div class="rs-shape-two">
                <img src="assets/images/shape/growth-shape.webp" alt="image">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-about-wrapper">
                            <div class="rs-about-content-wrapper">
                              ...
                              Best Business Strategy
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-20">Built for business growth
                                    </h2>
                                ...
                                <div class="rs-about-list-wrapper">
                                    <div class="rs-about-list-item">
                                        ...
                                        <p class="rs-about-list-desc"> Customized Strategy Solutions </p>
                                    </div>
                                    <div class="rs-about-list-item">
                                        <div class="rs-about-list-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                        ...
                                        <p class="rs-about-list-desc"> Industry-Specific Insights </p>
                                    </div>
                                    <div class="rs-about-list-item">
                                        <div class="rs-about-list-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                        ...
                                        <p class="rs-about-list-desc"> Startup & Enterprise Support </p>
                                    </div>
                                    <div class="rs-about-list-item">
                                        <div class="rs-about-list-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                        ...
                                        <p class="rs-about-list-desc"> Global Expansion Planning </p>
                                    </div>
                                </div>
                            </div>
                            <div class="rs-about-thumb wow fadeInRight" data-wow-delay=".3s" data-wow-duration="1s">
                                <img src="assets/images/work/working-thumb-02.webp" alt="image">
                                <div class="rs-about-meta">
                                    <div class="rs-about-meta-icon">
                                        <img src="assets/images/favicon.webp" alt="image">
                                    </div>
                                    <p class="rs-about-meta-desc">We ensure fastest management team -work</p>
                                    <div class="rs-about-meta-btn">
                                        <a class="rs-btn has-icon has-text is-text-primary has-border" href="about.php">About
                                            Us
                                            <span class="icon-box">
        ...
        <div class="rs-video-area rs-video-one rs-video-two">
            <div class="rs-video-bg-thumb include-bg" data-background="assets/images/bg/video-bg-thumb-03.webp">
            </div>
            <div class="container">
                    ...
                    <div class="col-xl-4">
                        <div class="rs-video-wrapper text-center">
                            <div class="rs-video-play-btn rs-tween_max_btn-yes gsap-move-no">
                                <a href="https://www.youtube.com/watch?v=go7QYaQR494" class="rs-play-btn popup-video is-large has-transparent-btn has-blur hover-primary"><i
                            ...
                            <div class="rs-cta-form">
                                ...
                                <form id="contact-form2" action="./assets/mailer.php" method="POST">
                                    <div class="rs-cta-input">
                                        <input id="name2" name="name" type="text" placeholder="Enter your email">
                                        <div class="rs-cta-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 16 12" fill="none">
                                                <path d="M15.8603 1.17969L11.0078 6.00091L15.8603 10.8221C15.948 10.6388 16.0012 10.4361 16.0012 10.2197V1.78216C16.0012 1.56569 15.948 1.36303 15.8603 1.17969Z" fill="white"></path>
                                                <path d="M14.5947 0.375H1.40716C1.19069 0.375 0.988031 0.428219 0.804688 0.515938L7.00666 6.68666C7.55503 7.23503 8.44678 7.23503 8.99516 6.68666L15.1971 0.515938C15.0138 0.428219 14.8111 0.375 14.5947 0.375Z" fill="white"></path>
                                                <path d="M0.140938 1.17969C0.0532188 1.36303 0 1.56569 0 1.78216V10.2197C0 10.4361 0.0532188 10.6388 0.140938 10.8221L4.99341 6.00091L0.140938 1.17969Z" fill="white"></path>
                                                <path d="M10.3447 6.66211L9.658 7.34877C8.74428 8.26248 7.2575 8.26248 6.34378 7.34877L5.65716 6.66211L0.804688 11.4833C0.988031 11.571 1.19069 11.6243 1.40716 11.6243H14.5947C14.8111 11.6243 15.0138 11.571 15.1971 11.4833L10.3447 6.66211Z" fill="white"></path>
                                            </svg>
                                        </div>
        ...
        <!-- services area start -->
        <section id="services" class="rs-services-area rs-services-three section-space">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        ...
                        Our Strategic Services
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left mb-15">High impact strategy services
                            </h2>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item is-item-active wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="rs-services-thumb">
                                    <img src="assets/images/services/services-thumb-07.webp" alt="image">
                                    <div class="rs-services-content">
                                        <div class="rs-services-info">
                                            ...
                                            <h5 class="rs-services-title"><a href="services-details.php">Growth Strategy</a></h5>
                                        </div>
                                        <p class="rs-services-desc rs-desc-height">Collaborations cultivating a global are
                                            community diverse
                                            individuals.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="rs-services-item is-item-active active wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <div class="rs-services-thumb">
                                    <img src="assets/images/services/services-thumb-08.webp" alt="image">
                                    <div class="rs-services-content">
                                        <div class="rs-services-info">
                                            <div class="rs-services-icon">
                                            ...
                                            <h5 class="rs-services-title"><a href="services-details.php">Strategic Planning</a>
                                            </h5>
                                        </div>
                                        <p class="rs-services-desc rs-desc-height">Collaborations cultivating a global are
                                            community
                            ...
                            <div class="rs-services-item is-item-active wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <div class="rs-services-thumb">
                                    <img src="assets/images/services/services-thumb-09.webp" alt="image">
                                    <div class="rs-services-content">
                                        <div class="rs-services-info">
                                            <div class="rs-services-icon">
                                            ...
                                            <h5 class="rs-services-title"><a href="services-details.php">Business Modeling</a>
                                            </h5>
                                        </div>
                                        <p class="rs-services-desc rs-desc-height">Collaborations cultivating a global are
                                            community
        ...
        <!-- work area start -->
        <section class="rs-working-area section-space rs-working-three">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                              ...
                              Best Business Strategy
                                ...
                                <div class="rs-working-btn">
                                    <div class="rs-feature-more-btn">
                                        <a class="rs-btn has-icon hover-secondary border-hover-primary" href="industry.php">
                                            Get Start Now
                                            <span class="icon-box">
                                    <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                       xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-counter-wrapper">
                            <div class="rs-counter-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="rs-counter-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <div class="rs-counter-icon">
                            ...
                            <div class="rs-counter-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <div class="rs-counter-icon">
                            ...
                            <div class="rs-counter-item wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                <div class="rs-counter-icon">
        ...
        <section id="portfolio" class="rs-portfolio-area rs-portfolio-four rs-swiper">
            <div class="container-fluid g-0">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-portfolio-slider">
                            <div class=" swiper" data-clone-slides="false" data-loop="true" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-center-mode="false" data-no-gap="true" data-effect="fade" data-delay="2000" data-item="1" data-item-xl="1" data-item-lg="1" data-item-md="1" data-item-sm="1" data-item-xs="1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-shape">
                                                    <img src="assets/images/shape/group-triangle-shape-03.webp" alt="">
                                                </div>
                                                ...
                                                <div class="rs-portfolio-info">
                                                    <h5 class="rs-portfolio-title"><a href="portfolio-details.php">Business Development
                                                            Planning</a></h5>
                                                    <span class="rs-portfolio-line"></span>
                                                    <p class="rs-portfolio-desc">collaborations cultivating a global community
                                            ...
                                            <div class="rs-portfolio-bg-thumb include-bg" data-background="assets/images/portfolio/portfolio-thumb-25.webp">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-content">
                                                ...
                                                <div class="rs-portfolio-info">
                                                    <h5 class="rs-portfolio-title"><a href="portfolio-details.php">Integrated
                                                            Innovations</a></h5>
                                                    <span class="rs-portfolio-line"></span>
                                                    <p class="rs-portfolio-desc">collaborations cultivating a global community
                                                        diverse individuals who are your dedicated.</p>
                                            ...
                                            <div class="rs-portfolio-bg-thumb include-bg" data-background="assets/images/portfolio/portfolio-thumb-26.webp">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-content">
                                                ...
                                                <div class="rs-portfolio-info">
                                                    <h5 class="rs-portfolio-title"><a href="portfolio-details.php">Bank Credit Collection
                                                            System</a></h5>
                                                    <span class="rs-portfolio-line"></span>
                                                    <p class="rs-portfolio-desc">collaborations cultivating a global community
                                                        diverse individuals who are your dedicated.</p>
                                            ...
                                            <div class="rs-portfolio-bg-thumb include-bg" data-background="assets/images/portfolio/portfolio-thumb-27.webp">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-content">
                                                ...
                                                <div class="rs-portfolio-info">
                                                    <h5 class="rs-portfolio-title"><a href="portfolio-details.php">Differentiated
                                                            Performance</a></h5>
                                                    <span class="rs-portfolio-line"></span>
                                                    <p class="rs-portfolio-desc">collaborations cultivating a global community
                                                        diverse individuals who are your dedicated.</p>
                                            ...
                                            <div class="rs-portfolio-bg-thumb include-bg" data-background="assets/images/portfolio/portfolio-thumb-28.webp">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="rs-working-wrapper wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                        <div class="rs-working-item item-one">
                            <div class="rs-video-wrapper">
                                <div class="rs-video-bg-thumb include-bg" data-background="assets/images/video/video-thumb-01.webp">
                                </div>
                                <div class="rs-video-wrapper text-center">
                                    <div class="rs-video-play-btn">
                                        <a href="https://www.youtube.com/watch?v=go7QYaQR494" class="rs-play-btn popup-video is-medium has-transparent-btn has-blur hover-primary"><i
                                    class="ri-play-large-fill"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="rs-progress-wrapper">
                                ...
                                <div class="rs-progress-item-wrapper">
                                    <div class="single-progress">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay=".3s" role="progressbar" style="width: 86%" aria-valuenow="86" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="single-progress">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay=".5s" role="progressbar" style="width: 95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="single-progress">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay=".7s" role="progressbar" style="width: 70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="rs-testimonial-area section-space rs-testimonial-three rs-swiper">
            <div class="container">
        ...
        <!-- faq area start -->
        <section class="rs-faq-area theme-secondary section-space-top rs-faq-two">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
        ...
        <!-- blog area start -->
        <section id="blog" class="rs-blog-area section-space rs-blog-two rs-swiper">
        ...
        <!-- contact area start -->
        <section id="contact" class="rs-contact-area rs-contact-two">
