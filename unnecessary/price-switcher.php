<?php $pageTitle = "Price Switcher"; include 'includes/head.php'; ?>
    ...
    <main>
                    ...
                    <div class="col-xl-8 col-lg-9">
                        <div class="rs-breadcrumb-wrapper">
                            ...
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Price Switcher</h1>
        ...
        <section class="rs-pricing-area rs-pricing-one section-space">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="rs-pricing-tab-switcher">
                            <div class="rs-pricing-tab-inner">
                                <div class="rs-pricing-switcher-tab">
                ...
                <div class="rs-pricing-switcher-wrapper monthly-pricing">
                    <div class="row g-5">
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-pricing-item">
                                ...
                                <p class="rs-pricing-desc">Provide the best services, ensuring undibo outstanding growth
                                    Lorem
                                    ipsum dolor.</p>
                                <div class="rs-pricing-btn">
                                    <a class="rs-btn has-icon has-theme-secondary w-100 radius-6" href="contact.php">Choose
                                        Your
                                        Plan
                                        <span class="icon-box">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-pricing-item active">
                ...
                <div class="rs-pricing-switcher-wrapper yearly-pricing">
                    <div class="row g-5">
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-pricing-item">
                                <h6 class="rs-pricing-title">Basic Plan</h6>
                                <div class="rs-pricing-amount-wrapper">
                                    <h3 class="rs-pricing-amount">$299</h3>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-pricing-item active">
                                <h6 class="rs-pricing-title">Business Plan</h6>
                                <div class="rs-pricing-amount-wrapper">
                                    <h3 class="rs-pricing-amount">$469</h3>
                                    <span class="rs-pricing-duration">/yearly</span>
                                </div>
                                <p class="rs-pricing-desc">Provide the best services, ensuring undibo outstanding growth
                                    Lorem
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-pricing-item">
                                <h6 class="rs-pricing-title">Premium Plan</h6>
                                <div class="rs-pricing-amount-wrapper">
                                    <h3 class="rs-pricing-amount">$999</h3>
                                    <span class="rs-pricing-duration">/yearly</span>
                                </div>
                                <p class="rs-pricing-desc">Provide the best services, ensuring undibo outstanding growth
                                    Lorem
