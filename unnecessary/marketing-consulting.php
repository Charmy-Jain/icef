<?php $pageTitle = "Marketing Consulting"; include 'includes/head.php'; ?>
    ...
    <main>
        ...
        <section class="rs-banner-area rs-banner-two rs-swiper">
            <div class="rs-banner-slider-wrapper">
                <div class="swiper" data-clone-slides="false" data-loop="false" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-center-mode="false" data-effect="fade" data-no-gap="true" data-delay="2000" data-item="1">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="rs-banner-wrapper">
                                <div class="rs-banner-bg-thumb include-bg" data-background="assets/images/bg/banner-bg-thumb-05.webp"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-6 col-xl-7 col-lg-8">
                                          ...
                                          Turning Vision Into Reality
                                                    ...
                                                    <h1 class="rs-banner-title rs-split-text-enable split-in-left">Expert Guidance For Sustainable Growth
                                                    </h1>
                                                    <span class="rs-banner-line"></span>
                                                    <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".5s">we believe that every business is uniquids our approach
                                                        is
                        ...
                        <div class="swiper-slide">
                            <div class="rs-banner-wrapper">
                                <div class="rs-banner-bg-thumb include-bg" data-background="assets/images/bg/banner-bg-thumb-06.webp"></div>
                                <div class="rs-banner-bg-thumb-two include-bg" data-background="assets/images/bg/noise-thumb.webp"></div>
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xxl-6 col-xl-7 col-lg-8">
                                          ...
                                          Turning Vision Into Reality
                                                    ...
                                                    <h1 class="rs-banner-title rs-split-text-enable split-in-left">Affordable Marketing Unmatched Result
                                                    </h1>
                                                    <span class="rs-banner-line"></span>
                                                    <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".5s">we believe that every business is uniquids our approach
                                                        is
                        ...
                        <div class="swiper-slide">
                            <div class="rs-banner-wrapper">
                                <div class="rs-banner-bg-thumb include-bg" data-background="assets/images/bg/banner-bg-thumb-07.webp"></div>
                                <div class="rs-banner-bg-thumb-two include-bg" data-background="assets/images/bg/noise-thumb.webp"></div>
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xxl-6 col-xl-7 col-lg-8">
                        ...
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-content-wrapper">
                              ...
                              Welcome to bustar Agency
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-30">Empowering businesses to
                                        achieve goals.</h2>
                                </div>
                                <div class="rs-about-thumb-two rs-image scroll_reveal reveal-active" data-dir="reveal_right">
                                ...
                                <div class="rs-about-list-wrapper">
                                    ...
                                    <p class="rs-about-list-desc">Our data analysis tools and techniques help you turn complex
                                        data into clear, strategic
                                        insights that improve performance and guide growth. </p>
                                    <div class="rs-about-list-item-wrapper">
                                        ...
                                        <div class="rs-about-list-item">
                                            ...
                                            <p> Innovation. Strategy. Success.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="rs-about-progress-wrapper">
                                    <h5 class="rs-about-progress-title">Achieve Goals</h5>
                                    <p class="rs-about-progress-desc">We aim to help businesses achieve sustainable growth
                                        through
                                        effective strategies, innovative thinking, and measurable results. Our goals center around
                                        delivering value, building strong client relationships, and staying ahead of industry
                                        trends.</p>
                                    <div class="rs-progress-wrapper">
                                        <div class="single-progress">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s" role="progressbar" style="width: 86%" aria-valuenow="86" aria-valuemin="0" aria-valuemax="100">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="single-progress">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s" role="progressbar" style="width: 95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="single-progress">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".7s" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!-- text clip area start  -->
        <section class="rs-text-clip-area rs-text-clip-one">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-text-clip">
                            <h2 class="rs-text-clip-title rs-text-clip-bg-thumb" data-background="assets/images/bg/text-clip-bg-thumb-01.webp">Bustar</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-7 col-lg-8 col-md-9">
                        ...
                        Your Business Our Expertise
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left is-white mb-10">Service for your
                                development</h2>
                            <p class="section-desc">We believe that every business is uniquids our approach is never growth.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="rs-services-thumb">
                                    ...
                                    <div class="rs-services-btn">
                                        <a class="rs-btn has-icon has-bg-white hover-primary has-md-radius w-100" href="services-details.php">Explore More
                                            <span class="icon-box">
                                    <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16"
                                       xmlns="http://www.w3.org/2000/svg">
                                       <path
                                ...
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title underline is-white"><a href="services-details.php"> Marketing
                                            Consulting</a></h5>
                            ...
                            <div class="rs-services-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                ...
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title underline is-white"><a href="services-details.php"> Financial
                                            Insurance</a></h5>
                                    <p class="rs-services-desc"> we analyze structured and unstructured data to help you optimize
                                        operations.</p>
                                    <div class="rs-services-list-wrapper">
                            ...
                            <div class="rs-services-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                ...
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title underline is-white"><a href="services-details.php"> Portfolio
                                            Management</a></h5>
                                    <p class="rs-services-desc"> Every number tells a story We analyze your data to uncover
                            ...
                            <div class="rs-services-item wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                ...
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title underline is-white"><a href="services-details.php"> Business
                                            Insurances</a></h5>
                                    <p class="rs-services-desc"> We provide the best services ensuring your outstanding growth
                                        Lorem ipsum dolor.</p>
                                    <div class="rs-services-list-wrapper">
                    ...
                    <div class="col-xl-12">
                        <div class="rs-cta-wrapper wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <div class="rs-cta-form">
                                <h5 class="rs-cta-title">Get a Consultations Today, itÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢s Free!</h5>
                                <form id="contact-form" action="./assets/mailer.php" method="POST">
                                    <div class="rs-cta-input">
                                        ...
                                        <button type="submit" class="rs-btn has-icon has-bg-secondary has-sm-radius">
                                            LetÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢s Talk
                                            <span class="icon-box">
                                    <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16"
                                       xmlns="http://www.w3.org/2000/svg">
                                       <path
                        ...
                        <div class="rs-feature-wrapper">
                            <div class="rs-feature-sec-wrapper">
                              ...
                              Build Your Industries
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-10">Industries we help</h2>
                                ...
                                <div class="rs-feature-more-btn">
                                    <a class="rs-btn has-icon hover-secondary border-hover-primary" href="industry.php">View All
                                        Industries
                                        <span class="icon-box">
        ...
        <section class="rs-why-choose-area rs-why-choose-two">
            <div class="rs-why-choose-bg-thumb include-bg" data-background="assets/images/bg/why-choose-bg-thumb-01.webp">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-why-choose-wrapper">
                           ...
                           Why choose us bustar
                                ...
                                <h2 class="section-title rs-split-text-enable split-in-left is-white mb-10">Achieving growth
                                    through collaboration</h2>
                                <p class="section-desc">We believe that every business is uniquids our approach is never one
                            ...
                            <div class="rs-why-choose-tab-wrapper">
                                <div class="rs-why-choose-tab">
                                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-item-two-tab" data-bs-toggle="pill" data-bs-target="#pills-item-two" type="button" role="tab" aria-controls="pills-item-two" aria-selected="false"> Why Choose us
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                ...
                                <div class="rs-why-chyoose-tab-content-wrapper">
                                    <div class="tab-content rs-why-choose-tab-anim" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabindex="0">
                                            <div class="rs-why-choose-tab-item">
                                                <div class="rs-why-choose-tab-thumb">
                                                    <img src="assets/images/why-choose/why-choose-thumb-02.webp" alt="image">
                                                </div>
                                                <div class="rs-why-choose-tab-content">
                                                    <h5 class="rs-why-choose-tab-title">Expert Consulting Proven Strategies</h5>
                                                    <p class="rs-why-choose-tab-desc"> We provide the best services ensuring your
                                                    ...
                                                    <div class="rs-why-choose-tab-list">
                                                        <div class="rs-why-choose-list-item">
                                                            ...
                                                            <p class="rs-why-choose-list-title"> Outstanding Performance </p>
                                                        </div>
                                                        <div class="rs-why-choose-list-item">
                                                            <div class="rs-why-choose-list-icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                                            ...
                                                            <p class="rs-why-choose-list-title"> Strategy Meets Technology </p>
                                                        </div>
                                                        <div class="rs-why-choose-list-item">
                                                            <div class="rs-why-choose-list-icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                                            ...
                                                            <p class="rs-why-choose-list-title"> Global Support Network </p>
                                                        </div>
                                                        <div class="rs-why-choose-list-item">
                                                            <div class="rs-why-choose-list-icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                                            ...
                                                            <p class="rs-why-choose-list-title"> Exceptional Communication </p>
                                                        </div>
                                                        <div class="rs-why-choose-list-item">
                                                            <div class="rs-why-choose-list-icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                                            ...
                                                            <p class="rs-why-choose-list-title"> Rapid Talent Acquisition </p>
                                                        </div>
                                                        <div class="rs-why-choose-list-item">
                                                            <div class="rs-why-choose-list-icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                                            ...
                                                            <p class="rs-why-choose-list-title"> 24/7 Availability Across Time </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-item-two" role="tabpanel" aria-labelledby="pills-item-two-tab" tabindex="0">
                                            <div class="rs-why-choose-tab-item">
                                                <div class="rs-why-choose-tab-thumb">
                                                    <img src="assets/images/why-choose/why-choose-thumb-03.webp" alt="image">
                                                </div>
                                                <div class="rs-why-choose-tab-content">
                                                    <h5 class="rs-why-choose-tab-title">Expert Consulting Proven Strategies</h5>
                                                    <p class="rs-why-choose-tab-desc"> We provide the best services ensuring your
                                        ...
                                        <div class="tab-pane fade" id="pills-item-three" role="tabpanel" aria-labelledby="pills-item-three-tab" tabindex="0">
                                            <div class="rs-why-choose-tab-item">
                                                <div class="rs-why-choose-tab-thumb">
                                                    <img src="assets/images/why-choose/why-choose-thumb-04.webp" alt="image">
                                                </div>
                                                <div class="rs-why-choose-tab-content">
                                                    <h5 class="rs-why-choose-tab-title">Expert Consulting Proven Strategies</h5>
                                                    <p class="rs-why-choose-tab-desc"> We provide the best services ensuring your
                                ...
                                <div class="tab-pane fade show active" id="pills-item-four" role="tabpanel" aria-labelledby="pills-item-four-tab" tabindex="0">
                                    <div class="rs-portfolio-tab-slider portfolio-slide-active p-relative fix">
                                        <div class=" swiper" data-clone-slides="false" data-loop="false" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-center-mode="false" data-no-gap="true" data-delay="2000" data-item="4" data-item-xl="3" data-item-lg="2" data-item-md="2" data-item-sm="1" data-item-xs="1">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide" data-background="assets/images/portfolio/portfolio-thumb-21.webp">
                                                ...
                                                <div class="swiper-slide" data-background="assets/images/portfolio/portfolio-thumb-17.webp">
                                                    <div class="rs-portfolio-tab-item">
                                                        <div class="rs-portfolio-tab-content">
                                                            <div class="rs-portfolio-tag-wrapper">
                                                                <div class="rs-portfolio-tag">
                                                ...
                                                <div class="swiper-slide" data-background="assets/images/portfolio/portfolio-thumb-18.webp">
                                                    <div class="rs-portfolio-tab-item">
                                                        <div class="rs-portfolio-tab-content">
                                                            <div class="rs-portfolio-tag-wrapper">
                                                                <div class="rs-portfolio-tag">
                                                ...
                                                <div class="swiper-slide" data-background="assets/images/portfolio/portfolio-thumb-19.webp">
                                                    <div class="rs-portfolio-tab-item">
                                                        <div class="rs-portfolio-tab-content">
                                                            <div class="rs-portfolio-tag-wrapper">
                                                                <div class="rs-portfolio-tag">
                                                ...
                                                <div class="swiper-slide" data-background="assets/images/portfolio/portfolio-thumb-20.webp">
                                                    <div class="rs-portfolio-tab-item">
                                                        <div class="rs-portfolio-tab-content">
                                                            <div class="rs-portfolio-tag-wrapper">
                                                                <div class="rs-portfolio-tag">
                                                ...
                                                <div class="swiper-slide" data-background="assets/images/portfolio/portfolio-thumb-16.webp">
                                                    <div class="rs-portfolio-tab-item">
                                                        <div class="rs-portfolio-tab-content">
                                                            <div class="rs-portfolio-tag-wrapper">
                                                                <div class="rs-portfolio-tag">
                                    ...
                                    <div class="rs-portfolio-tab-slider portfolio-slide-active p-relative fix">
                                        <div class=" swiper" data-clone-slides="false" data-loop="false" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-center-mode="false" data-no-gap="true" data-delay="2000" data-item="4" data-item-xl="3" data-item-lg="2" data-item-md="2" data-item-sm="1" data-item-xs="1">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide" data-background="assets/images/portfolio/portfolio-thumb-04.webp">
                                                    <div class="rs-portfolio-tab-item">
                                                        <div class="rs-portfolio-tab-content">
                                                            <div class="rs-portfolio-tag-wrapper">
                                                                <div class="rs-portfolio-tag">
                                                ...
                                                <div class="swiper-slide" data-background="assets/images/portfolio/portfolio-thumb-03.webp">
                                                    <div class="rs-portfolio-tab-item">
                                                        <div class="rs-portfolio-tab-content">
                                                            <div class="rs-portfolio-tag-wrapper">
                                                                <div class="rs-portfolio-tag">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="rs-testimonial-item">
                                                ...
                                                <p class="rs-testimonial-desc"> &ldquo;The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections from de Finibus Bonorum et Malorum by Cicero are also reproduced in their exact original form, accompanied by English versions.&rdquo;
                                                </p>
