<?php $pageTitle = "Corporate Consulting"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <!-- banner area start -->
        <section class="rs-banner-area rs-banner-four">
            <div class="rs-banner-shape-one">
                <img src="assets/images/shape/banner-shape-01.webp" alt="image">
            </div>
            <div class="rs-banner-shape-three">
                <img src="assets/images/shape/growth-shape-02.webp" alt="image">
            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-thumb">
                                <img src="assets/images/banner/banner-thumb-04.webp" alt="image">
                            ...
                            <div class="rs-banner-content-wrapper">
                                <div class="rs-banner-content">
                                    <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".5s">
                                        Strategic Growth for Modern Businesses
                                    </h1>
                                    <span class="rs-banner-line"></span>
                                    <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">we
                                        believe that every business is uniquids our approach is never
                                        one size.</p>
                                    <div class="rs-banner-btn wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">
                                ...
                                <div class="rs-banner-form rs-contact-two wow fadeInRight" data-wow-delay=".9s" data-wow-duration="1.1s">
                    ...
                    <div class="rs-text-slide-inner">
                        <div class="rs-text-slide-item">
                            ...
                            <div class="rs-text-slide-thumb">
                                <img src="assets/images/shape/multi-line-shape-two.webp" alt="image">
                            </div>
                        </div>
                        <div class="rs-text-slide-item">
        ...
        <!-- services area start -->
        <section class="rs-services-area rs-services-four section-space">
                        ...
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="rs-services-thumb">
                                    <a href="services-details.php"><img src="assets/images/services/services-thumb-10.webp" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title"><a href="services-details.php">Financial Insurance</a></h5>
                                    ...
                                    <div class="rs-services-btn">
                                        <a class="rs-btn has-icon hover-primary has-theme-secondary w-100 has-md-radius" href="services-details.php">Explore More
                                            <span class="icon-box">
                                    <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16"
                                       xmlns="http://www.w3.org/2000/svg">
                                       <path
                            ...
                            <div class="rs-services-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <div class="rs-services-thumb">
                                    <a href="services-details.php"><img src="assets/images/services/services-thumb-11.webp" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title"><a href="services-details.php">Risk Management</a></h5>
                                    <p class="rs-services-desc">Mitigation strategies and regulatory growth compliance for secure
                                        operations.</p>
                                    <div class="rs-services-list-wrapper">
                                        <div class="rs-services-list-item">
                                            <div class="rs-services-list-icon">
                            ...
                            <div class="rs-services-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <div class="rs-services-thumb">
                                    <a href="services-details.php"><img src="assets/images/services/services-thumb-12.webp" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title"><a href="services-details.php"> Portfolio Management</a></h5>
                                    <p class="rs-services-desc"> Complex data into clear and strategic insights that improve
                                        performance guide growth.</p>
                                    <div class="rs-services-list-wrapper">
                                        <div class="rs-services-list-item">
                                        ...
                                        <div class="rs-services-list-item">
                                            ...
                                            <p class="rs-services-list-desc"> Anit- Competitive Conduct </p>
                                        </div>
                                    </div>
                                    <div class="rs-services-btn">
                                        <a class="rs-btn has-icon hover-primary has-theme-secondary w-100 has-md-radius" href="services-details.php">Explore More
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-working-wrapper">
                            <div class="rs-working-content-wrapper">
                              ...
                              Best Business Strategy
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-20">Transforming strategy into
                                        scalable growth</h2>
                                    <p class="rs-section-desc">Corporate consulting is a professional service that helps
                                        businesses identify challenges, improve efficiency, and achieve their strategic goals.
                                        Consultants work closely with team.</p>
                                </div>
                                ...
                                <div class="rs-working-btn">
                                    <a class="rs-btn has-icon hover-secondary border-hover-primary" href="contact.php">Get Start
                                        Now
                                        <span class="icon-box">
                            ...
                            <div class="rs-working-thumb-wrapper wow fadeInRight" data-wow-delay=".3s" data-wow-duration="1s">
        ...
        <section class="rs-portfolio-area section-space rs-portfolio-three rs-swiper">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    ...
                    <div class="rs-portfolio-tab-content-wrapper">
                        <div class="tab-content rs-portfolio-tab-anim" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabindex="0">
                                <div class="rs-portfolio-tab-slider portfolio-slide-active">
                                    <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-center-mode="false" data-effect="false" data-delay="2000" data-item="4" data-item-xl="3" data-item-lg="3" data-item-md="2" data-item-sm="1" data-item-xs="1" data-margin="30">
                                                ...
                                                <div class="rs-portfolio-tab-item">
                                                    <div class="rs-portfolio-tab-thumb">
                                                        ...
                                                        <div class="rs-portfolio-tab-content">
                                                            <h5 class="rs-portfolio-tab-title underline is-white"><a href="portfolio-details.php">Online
                                                                    Invoicing & Billing Platform</a></h5>
                                                            <span class="rs-portfolio-line"></span>
                                                            <p class="rs-portfolio-desc rs-desc-height">Collaborations cultivating a
                                                                global community
                                                                diverse individuals who are your dedicated.</p>
                                                            <div class="rs-portfolio-tab-btn">
                                                                <a class="rs-btn has-icon has-text is-text-black" href="portfolio-details.php">Read More
                                                                    <span class="icon-box">
                                                      <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rs-portfolio-tab-item">
                                                    <div class="rs-portfolio-tab-thumb">
                                                        ...
                                                        <div class="rs-portfolio-tab-content">
                                                            <h5 class="rs-portfolio-tab-title underline is-white"><a href="portfolio-details.php">Market
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rs-portfolio-tab-item">
                                                    <div class="rs-portfolio-tab-thumb">
                                                        ...
                                                        <div class="rs-portfolio-tab-content">
                                                            <h5 class="rs-portfolio-tab-title underline is-white"><a href="portfolio-details.php">Integrated
                                                                    Innovations</a></h5>
                                                            <span class="rs-portfolio-line"></span>
                                                            <p class=" rs-desc-height">Collaborations cultivating a global community
                                                                diverse individuals who are your dedicated.</p>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rs-portfolio-tab-item">
                                                    <div class="rs-portfolio-tab-thumb">
                                                        ...
                                                        <div class="rs-portfolio-tab-content">
                                                            <h5 class="rs-portfolio-tab-title underline is-white"><a href="portfolio-details.php">Differentiated
                                                                    Performance</a></h5>
                                                            <span class="rs-portfolio-line"></span>
                                                            <p class=" rs-desc-height">Collaborations cultivating a global community
                                                                diverse individuals who are your dedicated.</p>
                            ...
                            <div class="tab-pane fade" id="pills-item-two" role="tabpanel" aria-labelledby="pills-item-two-tab" tabindex="0">
                                <div class="rs-portfolio-tab-slider portfolio-slide-active">
                                    <div class="swiper" data-clone-slides="false" data-loop="false" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-center-mode="false" data-effect="false" data-delay="2000" data-item="4" data-item-xl="3" data-item-lg="3" data-item-md="2" data-item-sm="1" data-item-xs="1" data-margin="30">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="rs-portfolio-tab-item">
                                                    <div class="rs-portfolio-tab-thumb">
        ...
        <!-- team area start -->
        <section class="rs-team-area rs-team-two section-space">
            <div class="container">
                <div class="row align-items-center g-5 section-title-space">
                    <div class="col-xl-7 col-lg-7">
                        ...
                        The Expert Teams Member
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left mb-10">Meet with consultant expert
                            </h2>
                        ...
                        <div class="rs-team-wrapper">
                            <div class="rs-team-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="rs-team-thumb">
                                    <a href="team-details.php"><img src="assets/images/team/team-thumb-04.webp" alt="image"></a>
                                    <div class="rs-team-social">
                                        <div class="theme-social has-transparent">
                                            <a href="#">
                                    ...
                                    <div class="rs-team-content-wrapper">
                                        <div class="rs-team-content-inner">
                                            ...
                                            <div class="rs-team-btn">
                                                <a class="rs-btn has-icon has-text is-white" href="team-details.php">
                                                    <span class="icon-box">
                                          <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <path
                                        ...
                                        <span class="rs-team-line"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="rs-team-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <div class="rs-team-thumb">
                                    <a href="team-details.php"><img src="assets/images/team/team-thumb-05.webp" alt="image"></a>
                                    <div class="rs-team-social">
                                        <div class="theme-social has-transparent">
                                            <a href="#">
                                                <i class="ri-facebook-fill"></i>
                                    ...
                                    <div class="rs-team-content-wrapper">
                                        <div class="rs-team-content-inner">
                                            ...
                                            <div class="rs-team-content-info">
                                                <h5 class="rs-team-title"><a href="team-details.php">Michael Roberts</a>
                                                </h5>

                                                <span class="rs-team-designation">Strategy Consultant</span>
                                            </div>
                                            <div class="rs-team-btn">
                                                <a class="rs-btn has-icon has-text is-white" href="team-details.php">
                                                    <span class="icon-box">
                ...
                <div class="row g-5">
                    <div class="col-xl-12">
                        <div class="rs-testimonial-slider-wrapper">
                            <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="false" data-delay="2000" data-item="3" data-item-xl="3" data-item-lg="2" data-item-md="2" data-item-sm="1" data-item-xs="1" data-margin="30">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="rs-blog-wrapper">
                        <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="false" data-delay="2000" data-item="3" data-item-xl="3" data-item-lg="3" data-item-md="2" data-item-sm="1" data-item-xs="1" data-margin="30">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
