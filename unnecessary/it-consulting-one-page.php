<?php $pageTitle = "IT Consulting One Page"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-eight">
        ...
        <!-- services area start -->
        <section id="services" class="rs-services-area section-space theme-secondary rs-services-eight">
