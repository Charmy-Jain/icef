<?php $pageTitle = "Financial Advisor One Page"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-six rs-swiper">
            <div class="rs-banner-bg-thumb include-bg" data-background="assets/images/bg/banner-bg-thumb-09.webp"></div>
            <div class="banner-shape-one">
                <img src="assets/images/shape/banner-shape-02.webp" alt="image">
            </div>
                        ...
                        <div class="rs-banner-wrapper">
                           ...
                           Affordable Effective Reliable
                            ...
                            <div class="rs-banner-thumb wow fadeInRight" data-wow-delay="1.1s" data-wow-duration="1.3s">
                                <img src="assets/images/banner/banner-thumb-05.webp" alt="image">
                                <h2 class="rs-text-clip-title" data-background="assets/images/bg/text-clip-bg-thumb-01.webp">B
                                </h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="rs-banner-brand">
                    <div class="rs-brand-area rs-brand-two">
                        <div class="brand-slider">
                            <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-center-mode="false" data-effect="false" data-no-gap="true" data-delay="1500" data-item="4" data-item-xl="3" data-item-lg="3" data-item-md="3" data-item-sm="2" data-item-xs="2" data-item-mobile="1">
        ...
        <!-- feature area start -->
        <section class="rs-feature-area rs-feature-eight">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
        ...
        <!-- about area start -->
        <section id="about" class="rs-about-area rs-about-five section-space-top">
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-content-left">
                              ...
                              About CV Solutions
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-20">The team behind your
                                        financial growth
                                    </h2>
                                    <p class="section-desc">We are a team of career experts, resume writers, and HR
                                        professionals dedicated to creating CVs that help you stand out and secure your job.</p>
                                </div>
                                <div class="rs-about-list-wrapper">
                                    <div class="rs-about-list-inner">
                            ...
                            <div class="rs-about-content-right">
                                <div class="rs-about-meta-wrapper">
                                    <div class="rs-about-meta-info">
                                        ...
                                        <h6 class="rs-about-meta-title">Contact Our Experts</h6>
                                    </div>
                                    <p class="rs-about-meta-desc">We provide the best services to ensuring your outstanding
                                        growth Lorem ipsum dolor sit.</p>
                                </div>
                                <div class="rs-about-thumb">
                                    <img src="assets/images/about/about-thumb-05.webp" alt="image">
                                    <div class="rs-about-award">
                                        <div class="rs-about-award-thumb">
                                            <img src="assets/images/shape/award-shape.webp" alt="image">
                                        </div>
                                        <p class="rs-about-award-desc">we believe that every business is uniquids our approach is
                                            never
        ...
        <!-- services area start -->
        <section id="services" class="rs-services-area rs-services-six section-space-top theme-secondary">
            <div class="container">
        ...
        <section id="portfolio" class="rs-portfolio-area section-space-top rs-portfolio-three rs-swiper has-bg-none has-tab-black">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-9">
                        ...
                        OUR FEATURED PROJECTS
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left">Case studies & highlights</h2>
                        </div>
                    </div>
                </div>
        ...
        <section class="rs-text-clip-area rs-text-clip-one">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-text-clip gsap-move-no rs-tween_max_btn-no">
        ...
        <!-- skill area start -->
        <section class="rs-skill-area section-space rs-skill-one theme-secondary">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-skill-wrapper">
                            <div class="rs-skill-thumb-wrapper">
                                <div class="rs-skill-thumb">
                                    <img src="assets/images/skill/skill-thumb-01.webp" alt="image">
                                    <div class="rs-skill-rotate-btn">
                                        <div class="rs-rotate-btn" data-background="assets/images/shape/half-rotate-shape-white.webp">
                                            <div class="rs-meta-shape">
                                                <img src="assets/images/shape/award-shape.webp" alt="image">
                                            </div>
                                        </div>
                            ...
                            <div class="rs-skill-content-wrapper">
                                <div class="section-title-wrapper">
                                    <span class="section-subtitle is-white">
                              Welcome to bustar Agency
                           </span>
                                    <h2 class="section-title rs-split-text-enable split-in-left is-white mb-30">Your trusted
                                        partner for financial growth</h2>
                                </div>
                                <div class="rs-skill-list-wrapper">
                                    <h5 class="rs-skill-list-title">Data Analysis</h5>
                                    <p class="rs-skill-list-desc">Our data analysis tools and techniques help you turn complex
                                        data into clear, strategic
                                        insights that improve performance and guide growth. </p>
                                    <div class="rs-skill-list-item-wrapper">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        ...
                        The Way We Guide You
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left mb-15">Your path to financial freedom
                            </h2>
        ...
        <!-- faq area start -->
        <section class="rs-faq-area section-space theme-secondary rs-faq-three">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-faq-wrapper">
                            ...
                            <div class="rs-faq-thumb">
                                ...
                                <div class="rs-faq-meta">
                                    <div class="rs-faq-meta-icon">
                                        <img src="assets/images/favicon.webp" alt="image">
                                    </div>
                                    <p class="rs-faq-meta-desc">We ensure fastest management team -work</p>
                                    <div class="rs-faq-meta-btn">
        ...
        <!-- blog area start -->
        <section id="blog" class="rs-blog-area section-space-bottom rs-blog-two rs-swiper">
            <div class="container">
                <div class="row justify-content-center">
                                            ...
                                            <div class="rs-blog-meta">
                                                <div class="rs-blog-meta-inner">
                                                    <div class="rs-blog-meta-item">
                                                        ...
                                                        <span> <a href="blog-details.php">Bustar</a> </span>
                                                    </div>
                                                    <div class="rs-blog-meta-item">
                                                        <div class="rs-blog-meta-icon">
