<?php $pageTitle = "HR Consulting One Page"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-five">
            <div class="rs-banner-shape">
                <img src="assets/images/shape/group-triangle-shape-02.webp" alt="image">
            </div>
            <div class="rs-banner-video-btn">
                ...
                <div class="row g-0">
                    <div class="col-xl-12">
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-bg-thumb include-bg" data-background="assets/images/bg/banner-bg-thumb-08.webp">
                            </div>
                            <div class="rs-banner-bg-thumb-two include-bg" data-background="assets/images/bg/noise-thumb.webp">
                            </div>
                           ...
                           Affordable Effective Reliable
                                ...
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">Tailored
                                    HR Support For Every Industry
                                </h1>
                                ...
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">we believe
                                    ...
                                    size
                                    fits all We tailor our strategies to fit your goals hub.</p>
                                <div class="rs-banner-btn wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1.1s">
                                    <a class="rs-btn has-icon has-bg-white has-bg-secondary" href="contact.php">Free
                                        Consultation
                                        <span class="icon-box">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-banner-feature-wrapper">
                            <div class="rs-banner-feature-item wow fadeIn" data-wow-delay="1s" data-wow-duration="1.2s">
                                ...
                                <div class="rs-banner-feature-content">
                                    <h5 class="rs-banner-feature-title">Submit Your Resume</h5>
                                    <span class="rs-banner-feature-line"></span>
                                    <p class="rs-banner-feature-desc"> Every number tells a story. We analyze your data to
                                        uncover patterns, highlight opportunities, and deliver insight.
                                    </p>
                                </div>
                            </div>
                            <div class="rs-banner-feature-item wow fadeIn" data-wow-delay="1.1s" data-wow-duration="1.3s">
                                <div class="rs-banner-feature-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 10">
                                        <path d="M5.53798 9.63481C5.50614 9.6348 5.47466 9.62821 5.4455 9.61545C5.41633 9.60269 5.39013 9.58404 5.36852 9.56066L0.799591 4.61839C0.769134 4.58544 0.748942 4.54433 0.741488 4.50008C0.734034 4.45584 0.73964 4.41038 0.757622 4.36927C0.775603 4.32816 0.805178 4.29318 0.842729 4.26862C0.880279 4.24406 0.924175 4.23098 0.969045 4.23098H3.16828C3.2013 4.23098 3.23393 4.23807 3.26398 4.25176C3.29403 4.26545 3.32079 4.28542 3.34246 4.31034L4.86941 6.06705C5.03444 5.71429 5.35389 5.12694 5.91448 4.41123C6.74321 3.35315 8.28471 1.79705 10.922 0.392315C10.973 0.36517 11.0323 0.358125 11.0882 0.372571C11.1441 0.387016 11.1926 0.421903 11.2241 0.470342C11.2555 0.51878 11.2676 0.57725 11.2581 0.634205C11.2485 0.69116 11.218 0.742461 11.1724 0.777976C11.1624 0.785846 10.1455 1.58662 8.97521 3.05336C7.89817 4.40313 6.46643 6.61021 5.76191 9.45951C5.74954 9.50957 5.72075 9.55404 5.68015 9.58583C5.63955 9.61762 5.58947 9.6349 5.53791 9.6349L5.53798 9.63481Z">
                                        </path>
                                ...
                                <div class="rs-banner-feature-content">
                                    <h5 class="rs-banner-feature-title">Free CV Review</h5>
                                    <span class="rs-banner-feature-line"></span>
                                    <p class="rs-banner-feature-desc"> Not getting interview calls? The problem might be your
                                        resume. I’ll analyze your CV and give you practical.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <!-- career area start -->
        <section class="rs-career-area rs-career-one section-space-bottom">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-career-wrapper">
                            <div class="rs-career-item item-one wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="rs-career-thumb">
                                    <img src="assets/images/career/career-thumb-01.webp" alt="image">
                                </div>
                                <div class="rs-career-content">
                                    <h5 class="rs-career-title">CV Management</h5>
                                    <p class="rs-career-desc">We provide the best services ensuring your outstanding growth
                                        Lorem.</p>
                                    <div class="rs-list-wrapper">
                                        <h6 class="rs-list-title">CV Solutions</h6>
                                        <div class="rs-list-item">
                                            <div class="rs-list-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                                    <path d="M5.53798 9.63481C5.50614 9.6348 5.47466 9.62821 5.4455 9.61545C5.41633 9.60269 5.39013 9.58404 5.36852 9.56066L0.799591 4.61839C0.769134 4.58544 0.748942 4.54433 0.741488 4.50008C0.734034 4.45584 0.73964 4.41038 0.757622 4.36927C0.775603 4.32816 0.805178 4.29318 0.842729 4.26862C0.880279 4.24406 0.924175 4.23098 0.969045 4.23098H3.16828C3.2013 4.23098 3.23393 4.23807 3.26398 4.25176C3.29403 4.26545 3.32079 4.28542 3.34246 4.31034L4.86941 6.06705C5.03444 5.71429 5.35389 5.12694 5.91448 4.41123C6.74321 3.35315 8.28471 1.79705 10.922 0.392315C10.973 0.36517 11.0323 0.358125 11.0882 0.372571C11.1441 0.387016 11.1926 0.421903 11.2241 0.470342C11.2555 0.51878 11.2676 0.57725 11.2581 0.634205C11.2485 0.69116 11.218 0.742461 11.1724 0.777976C11.1624 0.785846 10.1455 1.58662 8.97521 3.05336C7.89817 4.40313 6.46643 6.61021 5.76191 9.45951C5.74954 9.50957 5.72075 9.55404 5.68015 9.58583C5.63955 9.61762 5.58947 9.6349 5.53791 9.6349L5.53798 9.63481Z" fill="black"></path>
                                                </svg>
                                            </div>
                                            <p class="rs-list-desc"> Smart CVs for Smart Careers </p>
                                        </div>
                                        <div class="rs-list-item">
                                            <div class="rs-list-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                            ...
                                            <p class="rs-list-desc"> Helping You Land the Job </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="rs-career-item item-two wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <h5 class="rs-contact-title">Discover The Perfect Career</h5>
                            ...
                            <div class="rs-career-item item-three wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <div class="rs-counter-thumb">
                                    <img src="assets/images/career/career-thumb-02.webp" alt="image">
        ...
        <!-- work area start -->
        <section class="rs-working-area section-space-bottom rs-working-three">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                              ...
                              Best Business Strategy
                                ...
                                <div class="rs-working-btn">
                                    <div class="rs-feature-more-btn">
                                        <a class="rs-btn has-icon hover-secondary border-hover-primary" href="contact.php">
                                            Get Start Now
                                            <span class="icon-box">
        ...
        <!-- about area start -->
        <section id="about" class="rs-about-area rs-about-four section-space-bottom">
                    ...
                    <div class="col-xl-12">
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-thumb">
                                <img src="assets/images/about/about-thumb-04.webp" alt="image">
                                <div class="rs-about-progress-wrapper">
                                    <div class="rs-progress-wrapper">
                                        ...
                                        <div class="rs-progress-item-wrapper">
                                            <div class="single-progress">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s" role="progressbar" style="width: 95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="single-progress">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="rs-about-content-wrapper">
                              ...
                              About CV Solutions
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-20">Turning resumes into
                                        opportunities</h2>
                                    <p class="rs-section-desc">We are a team of career experts, resume writers, and HR
                                        professionals dedicated to creating CVs that help you stand out and secure your job.</p>
                                </div>
        ...
        <!-- services area start -->
        <section id="services" class="rs-services-area rs-services-five section-space">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        ...
                        Our Corporate Services
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left mb-15">Career services we provide
                            </h2>
                            ...
                            <div class="rs-services-item">
                              ...
                              01
                                ...
                                <div class="rs-services-content">
                                    ...
                                    <p class="rs-services-desc"> Believe a strong resume is the first toward a successful career
                                        our mission is to help job seekers present their skills, experience, and achievements with
                                        confidence.</p>
                                    <div class="rs-services-btn">
                                        <a class="rs-btn has-icon has-bg-white hover-primary" href="services-details.php">Explore
                                            More
                                            <span class="icon-box">
                                    <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16"
                                       xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="rs-services-thumb">
                                    <img src="assets/images/services/services-thumb-13.webp" alt="image">
                                </div>
                            </div>
                            <div class="rs-services-item">
                                <div class="rs-services-number">
                              ...
                              02
                                ...
                                <div class="rs-services-content">
                                    <h4 class="rs-services-title"><a href="services-details.php">HR Compliance & Policy Making
                                        </a></h4>
                                    <div class="rs-services-icon">
                                    ...
                                    <p class="rs-services-desc"> With years of experience in recruitment and HR, our team knows
                                        exactly what employers look for. We transform your story into a powerful resume that makes
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-value-content gsap-move-no rs-tween_max_btn-no">
                            <h2 class="rs-split-text-enable split-in-left rs-value-title" data-split-type="words" data-duration="0.8" data-delay="0.02">Company Values</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- career area start -->
        <section class="rs-career-area rs-career-two section-space">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        <div class="section-title-wrapper text-center section-title-space">
                        ...
                        Career Opportunities
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left mb-15">Join our career driven culture
                            </h2>
                        ...
                        <div class="rs-career-wrapper">
                            <div class="rs-career-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="rs-career-info">
                                    ...
                                    <span class="rs-career-company">Bustar Consulting Inc.</span>
                                </div>
                                <p class="rs-career-desc">Streamline your HR operations advanced automation and digital
                                    transformation solutions. From employee onboarding and payroll processing to performance.</p>
                                <div class="rs-career-btn">
                                    <a class="rs-btn has-icon hover-primary has-theme-secondary border-hover-primary" href="career.php">Apply Job Now
                                        <span class="icon-box">
                                 <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div class="rs-career-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                ...
                                <p class="rs-career-desc">Delivering expert guidance to ensure your projects are completed on
                                    time, within scope, and on budget. Our consulting services help organizations optimize.</p>
                                <div class="rs-career-btn">
                                    <a class="rs-btn has-icon hover-primary has-theme-secondary border-hover-primary" href="career.php">Apply Job Now
                                        <span class="icon-box">
                                 <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
                            ...
                            <div class="rs-career-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                ...
                                <p class="rs-career-desc">As a Business Analyst Manager, we specialize in analyzing business
                                    needs, identifying opportunities, and delivering data-driven solutions that align with
                            ...
                            <div class="rs-career-item wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                ...
                                <p class="rs-career-desc">We aim to help businesses achieve sustainable growth through effective
                                    strategies innovative thinking, and measurable results. Our goals the center around.</p>
                                <div class="rs-career-btn">
                                    <a class="rs-btn has-icon hover-primary has-theme-secondary border-hover-primary" href="career.php">Apply Job Now
                                        <span class="icon-box">
                                 <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
        ...
        <section id="portfolio" class="rs-portfolio-area rs-portfolio-two theme-secondary section-space-top rs-swiper">
            <div class="container-fluid">
                <div class="row justify-content-center">
                                                ...
                                                <div class="swiper-slide" data-bg="assets/images/portfolio/portfolio-thumb-21.webp">
                                                    <div class="rs-portfolio-tab-item">
                                                        <div class="rs-portfolio-tab-content">
                                                            ...
                                                            <h5 class="rs-portfolio-tab-title"><a href="portfolio-details.php">Bank
                                                                    Credit
                                                ...
                                                <div class="swiper-slide" data-bg="assets/images/portfolio/portfolio-thumb-24.webp">
                                                    <div class="rs-portfolio-tab-item">
                                                        <div class="rs-portfolio-tab-content">
                                                            ...
                                                            <h5 class="rs-portfolio-tab-title"><a href="portfolio-details.php">Green
                                                                    Energy
                                                                    Hub</a></h5>
                                                            <span class="rs-banner-line"></span>
        ...
        <!-- team area start -->
        <section class="rs-team-area rs-team-three secondary-bg section-space">
            <div class="container">
                <div class="row align-items-center g-5 section-title-space">
                    <div class="col-xl-7 col-lg-7">
                        ...
                        Our HR Experts
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left mb-10">Dedicated hr expert team
                            </h2>
                            <p class="section-desc">Focus on serving mid-size to enterprise-level companies looking</p>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-team-more-btn d-flex justify-content-lg-end">
                            <a class="rs-btn has-icon hover-secondary border-hover-primary" href="team.php">
                                View More Member
                                <span class="icon-box">
                           <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-team-wrapper">
                            <div class="rs-team-item rs-hover-sync">
                                <div class="rs-team-thumb-wrapper">
                                    <div class="rs-team-thumb active rs-sync-thumb" data-background="assets/images/team/team-thumb-04.webp">
                                    </div>
                                    <div class="rs-team-thumb rs-sync-thumb" data-background="assets/images/team/team-thumb-05.webp">
                                    </div>
                                    <div class="rs-team-thumb rs-sync-thumb" data-background="assets/images/team/team-thumb-06.webp">
                                    </div>
                                    <div class="rs-team-thumb rs-sync-thumb" data-background="assets/images/team/team-thumb-03.webp">
                                    </div>
                                    <div class="rs-team-thumb rs-sync-thumb" data-background="assets/images/team/team-thumb-02.webp">
                                    </div>
                                    <div class="rs-team-thumb rs-sync-thumb" data-background="assets/images/team/team-thumb-01.webp">
                                    </div>
                                </div>
                                <div class="rs-team-content-wrapper">
                                    <div class="rs-team-content-item rs-sync-item">
                                        <h5 class="rs-team-title"><a href="team-details.php">Brooklyn Simmons</a></h5>
                                        <span class="rs-team-desig">Sr. Analyst Finance</span>
                                    ...
                                    <div class="rs-team-content-item rs-sync-item">
                                        <h5 class="rs-team-title"><a href="team-details.php">Darlene Robertson</a></h5>
                                        <span class="rs-team-desig">Marketing Coordinator</span>
                                        <div class="rs-team-btn">
                                            <a class="rs-btn has-icon has-text" href="team-details.php">
                                                <span class="icon-box">
                                       <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    ...
                                    <div class="rs-team-content-item rs-sync-item">
                                        <h5 class="rs-team-title"><a href="team-details.php">Leslie Alexander</a></h5>
                                        <span class="rs-team-desig">Nursing Assistant</span>
                                        <div class="rs-team-btn">
                                            <a class="rs-btn has-icon has-text" href="team-details.php">
                                                <span class="icon-box">
                                       <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    ...
                                    <div class="rs-team-content-item rs-sync-item">
                                        <h5 class="rs-team-title"><a href="team-details.php">Savannah Nguyen</a></h5>
                                        <span class="rs-team-desig">President of Sales</span>
                                        <div class="rs-team-btn">
                                            <a class="rs-btn has-icon has-text" href="team-details.php">
                                                <span class="icon-box">
                                       <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    ...
                                    <div class="rs-team-content-item rs-sync-item">
                                        <h5 class="rs-team-title"><a href="team-details.php">Jessica Taylor</a></h5>
                                        <span class="rs-team-desig">Business Analyst</span>
                                        <div class="rs-team-btn">
                                            <a class="rs-btn has-icon has-text" href="team-details.php">
                                                <span class="icon-box">
                                       <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    ...
                                    <div class="rs-team-content-item rs-sync-item">
                                        <h5 class="rs-team-title"><a href="team-details.php">Darrell Steward</a></h5>
                                        <span class="rs-team-desig">Product Manager</span>
                                        <div class="rs-team-btn">
                                            <a class="rs-btn has-icon has-text" href="team-details.php">
                                                <span class="icon-box">
                                       <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
        ...
        <section class="rs-testimonial-area section-space-top rs-testimonial-two rs-swiper">
            <div class="rs-testimonial-bg-thumb include-bg" data-background="assets/images/bg/testimonial-bg-thumb-02.webp"></div>
        ...
        <!-- blog area start -->
        <section id="blog" class="rs-blog-area rs-blog-one section-space">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-7">
                        <div class="section-title-wrapper text-center section-title-space">
        ...
        <!-- contact area start -->
        <section id="contact" class="rs-contact-area rs-contact-one section-space-bottom">
