<?php $pageTitle = "Business Strategy"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <!-- banner area start -->
        <section class="rs-banner-area rs-banner-three rs-swiper">
        ...
        <!-- about area start -->
        <section class="rs-about-area rs-about-three section-space">
        ...
        <!-- services area start -->
        <section class="rs-services-area rs-services-three section-space">
            <div class="container">
                <div class="row justify-content-center">
        ...
        <section class="rs-portfolio-area rs-portfolio-four rs-swiper">
            <div class="container-fluid g-0">
                <div class="row">
                    <div class="col-xl-12">
