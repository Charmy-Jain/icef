<?php $pageTitle = "Insurance Consulting One Page"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <!-- services area start -->
        <section id="services" class="rs-services-area section-space rs-services-nine rs-swiper">
            <div class="container">
        ...
        <!-- about area start -->
        <section id="about" class="rs-about-area rs-about-eight section-space-bottom">
