<?php $pageTitle = "Financial Advisor"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <!-- banner area start -->
        <section class="rs-banner-area rs-banner-six rs-swiper">
        ...
        <!-- about area start -->
        <section class="rs-about-area rs-about-five section-space-top">
        ...
        <section class="rs-portfolio-area section-space-top rs-portfolio-three rs-swiper has-bg-none has-tab-black">
            <div class="container-fluid">
                <div class="row justify-content-center">
        ...
        <!-- blog area start -->
        <section class="rs-blog-area section-space-bottom rs-blog-two rs-swiper">
            <div class="container">
                <div class="row justify-content-center">
