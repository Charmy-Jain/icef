<?php $pageTitle = "About"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
                    ...
                    <div class="col-xl-8 col-lg-9">
                        <div class="rs-breadcrumb-wrapper">
                            ...
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">About Bustar</h1>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-content-wrapper">
                              ...
                              Best Business Strategy
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-20">Build for business growth
                                    </h2>
                                ...
                                <div class="rs-progress-item-wrapper">
                                    <div class="single-progress">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s" role="progressbar" style="width: 95%; visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInLeft;" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="single-progress">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s" role="progressbar" style="width: 90%; visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: fadeInLeft;" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="rs-about-thumb">
                                <img src="assets/images/about/about-thumb-09.webp" alt="image">
                    ...
                    <div class="col-xl-4">
                        <div class="rs-video-wrapper text-center">
                            <div class="rs-video-play-btn rs-tween_max_btn-yes gsap-move-no">
                                <a href="https://www.youtube.com/watch?v=go7QYaQR494" class="rs-play-btn popup-video is-large is-white has-bg-gradient"><i
        ...
        <!-- services area start -->
        <section class="rs-services-area rs-services-ten section-space theme-secondary">
            <div class="container">
                <div class="row justify-content-center">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-services-wrapper" id="rs-timeline-wrapper">
                            <div class="rs-services-item-wrapper">
                                <div class="rs-services-item rs-timeline-item">
                                    <div class="rs-services-content">
                                        <div class="rs-services-content-info">
                                            <div class="info-left">
                                                <span class="rs-services-meta">2001 - 2004</span>
                                                <h4 class="rs-services-title">Started Operation</h4>
                                            </div>
                                            <div class="info-right">
                                                <span class="rs-services-number">01</span>
                                            </div>
                                        </div>
                                        <p class="rs-services-desc">“Solutions, and measurable results are results committed
                                            understanding each client’s unique challenges and unique measurable is understanding
                                            client’s committed understanding each”</p>
                                    </div>
                                    <div class="rs-services-thumb">
                                        <img src="assets/images/services/services-thumb-30.webp" alt="image">
                                    </div>
                                </div>
                                <div class="rs-services-item rs-timeline-item">
                                    <div class="rs-services-thumb">
                                        <img src="assets/images/services/services-thumb-31.webp" alt="image">
                                    </div>
                                    <div class="rs-services-content">
                                        <div class="rs-services-content-info">
                                            <div class="info-left">
                                                <span class="rs-services-meta">2005 - 2008</span>
                                                <h4 class="rs-services-title">Business Strategy</h4>
                                            </div>
                                            <div class="info-right">
                                ...
                                <div class="rs-services-item rs-timeline-item">
                                    <div class="rs-services-content">
                                        <div class="rs-services-content-info">
                                            <div class="info-left">
                                                <span class="rs-services-meta">2009 - 20012</span>
                                                <h4 class="rs-services-title">Financial Advisory</h4>
                                            </div>
                                            <div class="info-right">
                                    ...
                                    <div class="rs-services-thumb">
                                        <img src="assets/images/services/services-thumb-32.webp" alt="image">
                                    </div>
                                </div>
                                <div class="rs-services-item rs-timeline-item">
                                    <div class="rs-services-thumb">
                                        <img src="assets/images/services/services-thumb-33.webp" alt="image">
                                    </div>
                                    <div class="rs-services-content">
                                        <div class="rs-services-content-info">
                                            <div class="info-left">
                                                <span class="rs-services-meta">2013 - 2016</span>
                                                <h4 class="rs-services-title">Risk Management</h4>
                                            </div>
                                            <div class="info-right">
                            ...
                            <div class="rs-why-choose-content-wrapper">
                              ...
                              Why choose us bustar
                                ...
                                <div class="rs-why-choose-btn">
                                    <a class="rs-btn has-icon hover-secondary border-hover-primary" href="about.php">Get Start Now
                                        <span class="icon-box">
                                 <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
        ...
        <!-- feature area start -->
        <section class="rs-feature-area rs-feature-three section-space-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-feature-wrapper">
