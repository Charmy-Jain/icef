                    ...
                    <div class="col-xl-12">
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content">
                                ...
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">We
                                    believe
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9 col-lg-10">
                        <div class="section-title-wrapper text-center section-title-space">
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left mb-15">Solving IT Challenges
                                Everywhere
                            </h2>
                            <p class="section-desc">Position your agency as the bridge between a
                                clientÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s big-picture
                                vision
                                and achievable
                            </p>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-feature-wrapper wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <?php
                            $features = [
                                ["thumb" => "05", "title" => "Advanced Manufacturing"],
                                ["thumb" => "06", "title" => "Financial Services"],
                                ["thumb" => "07", "title" => "Energy & Natural Resources"],
                                ["thumb" => "08", "title" => "Government"],
                                ["thumb" => "09", "title" => "Healthcare & Life Sciences"],
                                ["thumb" => "13", "title" => "Cybersecurity in Finance"],
                                ["thumb" => "14", "title" => "Financial Data Analytics"],
                                ["thumb" => "10", "title" => "Agribusiness"],
                                ["thumb" => "15", "title" => "Payment Processing"],
                                ["thumb" => "16", "title" => "FinTech Solutions"],
                                ["thumb" => "17", "title" => "Digital Banking"],
                                ["thumb" => "11", "title" => "Public Sector"],
                                ["thumb" => "12", "title" => "Retail & Consumer Goods"]
                            ];
                        ...
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-content-wrapper">
                                <div class="section-title-wrapper">
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left is-white mb-20">About us
                                        ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ your
                                        trusted immigration guide</h2>
                                    <p class="section-desc is-white">We are a trusted immigration consultancy dedicated
                                        to
                                        helping
                                        individuals families, students, and professionals achieve their global dreams.
                                        With years
                        ...
                        <div class="rs-working-wrapper">
                            <div class="rs-working-content-wrapper">
                                <div class="section-title-wrapper">
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-20">Transforming
                                        strategy into
                                        scalable growth</h2>
                                    <p class="rs-section-desc">Corporate consulting is a professional service that helps
                                        businesses identify challenges, improve efficiency, and achieve their strategic
                                        goals.
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-9">
                        <div class="section-title-wrapper text-center section-title-space">
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left is-white mb-10">Service for your
                                development</h2>
                            <p class="section-desc is-white">We believe that every business is uniquids our approach is
                                never
                                growth.
                            </p>
                        </div>
                            ...
                            <div class="rs-services-item active-item active wow fadeIn" data-wow-delay=".1s"
                                ...
                                <div class="rs-services-info">
                                    ...
                                    <div class="rs-services-content">
                                        ...
                                        <p class="rs-services-desc"> Believe a strong resume is the first toward a
                                            successful
                                            career
