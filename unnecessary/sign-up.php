<?php $pageTitle = "Sign Up"; include 'includes/head.php'; ?>
                    ...
                    <div class="col-xl-8 col-lg-9">
                        <div class="rs-breadcrumb-wrapper">
                            ...
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Sign Up</h1>
                ...
                <div class="row gx-0 gy-0 justify-content-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="rs-login-wrapper text-center">
                            <h3 class="rs-login-title mb-30">Registration</h3>
                            <form id="contact-form" action="./assets/mailer.php" method="POST">
                                <div class="row gy-24 align-items-center justify-content-between">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-input-box">
                                            ...
                                            <div class="form-input">
                                                <input name="phone" id="phone" type="text" required placeholder="Phone Number">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                ...
                                <div class="rs-login-btn mt-20">
                                    <button type="submit" class="rs-btn hover-secondary">Sign Up</button>
                                </div>
                            </form>
                            ...
                            <div class="rs-login-label text-center">
                                Don't have an account?<a href="login.php" class="rs-login-link"> Sign In</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6">
