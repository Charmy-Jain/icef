<?php $pageTitle = "Services Details 02"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
                    ...
                    <div class="col-xl-8 col-lg-9">
                        <div class="rs-breadcrumb-wrapper">
                            ...
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Services Details 02</h1>
        ...
        <!-- video area start -->
        <div class="rs-video-area rs-video-four section-space-top">
            <div class="container">
                <div class="row">
                    <div class="rs-video-wrapper">
                        <video loop="" muted="" autoplay="" playsinline="">
                            <source src="assets/video/video-02.php" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-services-details-wrapper">
                            <h3 class="rs-services-details-title mt-45 mb-15">What we’ve accomplished together</h3>
                            <p class="rs-services-details-desc desc-one">Discover how we’ve helped businesses grow transform
                                and succeed
                            ...
                            <p class="rs-services-details-desc desc-two">“Projects how we’ve helped businesses grow transform
                                and
                            ...
                            <h3 class="rs-services-details-title mb-10">Services Overview</h3>
                            <p class="rs-services-desc desc-three">succeed how we’ve helped businesses grow transform and
                                succeed through strategic consulting
                                solutions. Explore our portfolio of impactful projects each tailored to solve unique business
                                challenges. From startups to established enterprises our projects demonstrate real-world results
                                ...
                                growth, and sustainable change Every project tells a story of transformation dive into the
                                journeys of our clients and the results we delivered.</p>
                            <div class="rs-services-details-working-list">
                            ...
                            <div class="rs-services-details-content-wrapper">
                                <div class="rs-services-details-content-left">
                                    ...
                                    <div class="rs-services-details-content-list">
                                        <p>
                                ...
                                <div class="rs-services-details-content-right">
                                    <div class="rs-services-details-thumb">
