<?php $pageTitle = "Services 02"; include 'includes/head.php'; ?>
                    ...
                    <div class="col-xl-8 col-lg-9">
                        <div class="rs-breadcrumb-wrapper">
                            ...
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Services 02</h1>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-services-wrapper">
                            ...
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.php"><img src="assets/images/services/services-thumb-37.webp" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title"><a href="services-details.php">Business Modeling</a></h5>
                                    <p class="rs-services-desc">Complex data into clear and strategic insights that improve
                                        performance guide growth.</p>
                                    <div class="rs-services-list-wrapper">
                                        <div class="rs-services-list-item">
                            ...
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.php"><img src="assets/images/services/services-thumb-38.webp" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title"><a href="services-details.php">Strategic Planning</a></h5>
                                    <p class="rs-services-desc">Mitigation strategies and regulatory growth compliance for secure
                                        operations.</p>
                                    <div class="rs-services-list-wrapper">
                                        <div class="rs-services-list-item">
                            ...
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.php"><img src="assets/images/services/services-thumb-39.webp" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
