<?php $pageTitle = "Portfolio Details 02"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
                    ...
                    <div class="col-xl-8 col-lg-9">
                        <div class="rs-breadcrumb-wrapper">
                            ...
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Portfolio Details 02</h1>
                ...
                <div class="row">
                    <div class="rs-video-wrapper">
                        <video loop="" muted="" autoplay="" playsinline="">
                            <source src="assets/video/video.php" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
        ...
        <section class="rs-portfolio-area section-space-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
