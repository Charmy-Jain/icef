<?php $pageTitle = "Our Team"; include 'includes/head.php'; ?>
...
<body class="rs-smoother-yes">
    ...
    <main>
                    ...
                    <div class="col-xl-8 col-lg-9">
                        <div class="rs-breadcrumb-wrapper">
                            ...
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Our Team</h1>
                    ...
                    <div class="col-xl-12">
                        <div class="rs-team-wrapper">
                            ...
                            <div class="rs-team-item">
                                ...
                                <div class="rs-team-content-wrapper">
                                    <div class="rs-team-content-info">
                                        <h5 class="rs-team-title"><a href="team-deatils.php">Ronald Richards</a>
                                        </h5>
                            ...
                            <div class="rs-team-item">
                                <div class="rs-team-thumb">
                                    <a href="team-details.php"><img src="assets/images/team/team-thumb-07.webp" alt="image"></a>
                                </div>
                                <div class="rs-team-content-wrapper">
                                    <div class="rs-team-content-info">
                                        <h5 class="rs-team-title"><a href="team-details.php">Leslie
                            ...
                            <div class="rs-team-item">
                                <div class="rs-team-thumb">
                                    <a href="team-details.php"><img src="assets/images/team/team-thumb-08.webp" alt="image"></a>
                                </div>
                                <div class="rs-team-content-wrapper">
                                    <div class="rs-team-content-info">
                                        <h5 class="rs-team-title"><a href="team-details.php">Devon Lane</a>
                                        </h5>
                                        <span class="rs-team-designation">Business Analyst</span>
                                    </div>
                                    <div class="rs-team-btn">
                                        <a class="rs-btn has-icon has-text" href="team-details.php">
                                            <span class="icon-box">
                            ...
                            <div class="rs-team-item">
                                <div class="rs-team-thumb">
                                    <a href="team-details.php"><img src="assets/images/team/team-thumb-06.webp" alt="image"></a>
                                </div>
                                <div class="rs-team-content-wrapper">
                                    <div class="rs-team-content-info">
                                        <h5 class="rs-team-title"><a href="team-deatils.php">Jenny Wilson</a>
                                        </h5>
                                        <span class="rs-team-designation">Consulting Specialist</span>
                                    </div>
                                    <div class="rs-team-btn">
                                        <a class="rs-btn has-icon has-text" href="team-details.php">
                                            <span class="icon-box">
        ...
        <!-- pricing area start -->
        <section class="rs-pricing-area rs-pricing-one section-space-bottom">
            <div class="container">
                <div class="row justify-content-center">
