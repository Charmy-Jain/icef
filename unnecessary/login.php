                    ...
                    <div class="col-xl-8 col-lg-9">
                        <div class="rs-breadcrumb-wrapper">
                            ...
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Login</h1>
                ...
                <div class="row gx-0 gy-0 justify-content-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="rs-login-wrapper text-center">
                            <h3 class="rs-login-title mb-30">Login</h3>
                            <form id="contact-form" action="./assets/mailer.php" method="POST">
                                ...
                                <div class="rs-login-meta d-flex justify-content-between flex-wrap gap-10 mb-20">
                                    <div class="rs-login-remember">
                                        <input id="remeber" type="checkbox">
                                        <label for="remeber">Remember me</label>
                                    </div>
                                    <div class="rs-login-forgot">
                                        <a href="forgot.php" class="rs-login-link">Forgot Password?</a>
                                    </div>
                                </div>
                                <div class="rs-login-btn">
                                    <button type="submit" class="rs-btn hover-secondary">Sign in</button>
                                </div>
                            </form>
