<?php $pageTitle = "Customized Software Development";
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <section id="home" class="rs-banner-area rs-banner-one">
            <div class="rs-banner-bg-thumb include-bg" data-background="assets/images/solution/software-dev.webp"></div>
                        ...
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content-wrapper">
                                <span class="rs-banner-subtitle wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".5s">
                                   Precision-Built Enterprises
                                </span>
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s" style="font-size: 54px; line-height: 1.3;">
                                    Enterprise Grade &amp; <br><span id="demo-typed-text" style="color:#AB052D;"></span><span class="demo-typed-cursor" style="color:#AB052D; font-weight:300;">|</span>
                                </h1>
                                <span class="rs-banner-line"></span>
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">Robust, secure, and scalable software solutions designed to streamline your business-specific workflows and operations.</p>
                        ...
                        <div class="rs-banner-thumb rs-banner-form-wrap wow fadeInRight" data-wow-delay="1.1s" data-wow-duration="1.3s">
                            <div class="rs-banner-contact-form" style="padding: 24px;">
                                ...
                                <?php 
                                    ...
                                    $selected_sub_service = "customized_software";
        ...
        <script>
        (function() {
            var text = "Custom Software Solutions";
                    ...
                    <div class="col-xxl-7 col-xl-8">
                        <div class="rs-feature-info-wrapper wow fadeInUp" data-wow-delay="1.3s" data-wow-duration="1.5s">
                            <div class="rs-feature-info-list-wrapper">
                                ...
                                <a href="application-development.php" class="rs-feature-info-list-item">
                                    <div class="rs-feature-info-content">
                                ...
                                <a href="emerging-tech.php" class="rs-feature-info-list-item">
                                    <div class="rs-feature-info-content">
