    ...
    <style>
        ...
        * {
        ...
        .cta-button:hover {
            ...
            box-shadow: 0 8px 25px rgba(255, 207, 0, 0.4);
...
<body>
    ...
    <div class="container">
        ...
        <div class="timeline" role="list">
            ...
            <div class="timeline-item" role="listitem">
                <div class="card">
                    <img src="assets/images/banner/banner-thumb-02.webp" alt="IT & Emerging Tech Solution">
                </div>
                <div class="connector"></div>
                <div class="label">
                    <div class="year">06</div>
                    <div class="gen-name">IT & Emerging Tech</div>
                </div>
            </div>
        </div>
