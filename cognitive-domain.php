<?php $pageTitle = "Cognitive Domain Assessments";
...
<body class="rs-smoother-yes">
    ...
    <main>
        ...
        <section id="home" class="rs-banner-area rs-banner-one">
            <div class="rs-banner-bg-thumb include-bg" data-background="assets/images/solution/cognitive-domain.webp"></div>
                        ...
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content-wrapper">
                                <span class="rs-banner-subtitle wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".5s">
                                   Advanced Psychometric Evaluation
                                </span>
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s" >
                                    Cognitive &amp; <br><span id="demo-typed-text" style="color:#AB052D;"></span><span class="demo-typed-cursor" style="color:#AB052D; font-weight:300;">|</span>
                                </h1>
                                <span class="rs-banner-line"></span>
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">Measure intellectual capabilities and mental agility with our scientifically-validated cognitive assessment frameworks.</p>
                        ...
                        <div class="rs-banner-thumb rs-banner-form-wrap wow fadeInRight" data-wow-delay="1.1s" data-wow-duration="1.3s">
                            <div class="rs-banner-contact-form" style="padding: 24px;">
                                ...
                                <?php 
                                    ...
                                    $selected_sub_service = "cognitive";
        ...
        <script>
        (function() {
            var text = "Intellectual Competency Mapping";
                    ...
                    <div class="col-xxl-7 col-xl-8">
                        <div class="rs-feature-info-wrapper wow fadeInUp" data-wow-delay="1.3s" data-wow-duration="1.5s">
                            <div class="rs-feature-info-list-wrapper">
                                <a href="assessment-and-testing.php" class="rs-feature-info-list-item">
