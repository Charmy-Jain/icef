<?php $pageTitle = "IT & Emerging Tech";
                        ...
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content">
                                ...
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">
                                    Scalable IT Infrastructure & Emerging Tech Integration
                                </h1>
                                <span class="rs-banner-line"></span>
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">Transform your business with cutting-edge technology solutions, from cloud migration and cybersecurity to AI-driven automation.</p>
                            ...
                            <div class="rs-banner-thumb rs-banner-form-wrap wow fadeInRight" data-wow-delay="1.1s" data-wow-duration="1.3s">
                                ...
                                <img src="assets/images/banner/banner-thumb-02.webp" alt="image" class="rs-banner-bg-img">
                                <div class="rs-banner-contact-form">
                                    ...
                                    <form action="#" method="POST" class="rs-contact-form-banner">
                                        ...
                                        <div class="rs-form-row">
                                            <div class="rs-form-group">
                                                <select name="service">
                                                    <option value="" disabled selected>IT Domain</option>
                                ...
                                <div class="rs-banner-feature">
                                    <div class="rs-banner-feature-inner">
                                        ...
                                        <div class="rs-banner-feature-content">
                                            <h5 class="rs-banner-feature-title">Future-Ready IT</h5>
                                            <p class="rs-banner-feature-desc">Accelerating your digital roadmap with cloud, AI, and robust security protocols.</p>
                                            <div class="rs-banner-feature-btn">
                                                <a class="rs-btn has-icon has-text is-text-white has-border has-border-white" href="services.php">Get Start Now
                                                    <span class="icon-box">
                                                        <svg class="icon-first" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <svg class="icon-second" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M12.0743 8.70831L0.916528 8.70831L0.916528 6.87526L12.0737 6.87461L7.15722 1.95816L8.45358 0.661793L15.5836 7.79179L8.45358 14.9218L7.15722 13.6254L12.0743 8.70831Z" fill="white"></path>
                                                        </svg>
                                                    </span>
                                                </a>
