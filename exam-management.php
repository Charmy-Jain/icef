                        ...
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content">
                                <span class="rs-banner-subtitle wow fadeInUp" data-wow-delay=".3s"
                                    ...
                                    Precision. Security. Efficiency.
                                </span>
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">
                                    Comprehensive Examination Lifecycle Management
                                </h1>
                                <span class="rs-banner-line"></span>
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">We streamline the entire examination process, from center management and logistics to secure result processing and data analytics.</p>
                            ...
                            <div class="rs-banner-thumb rs-banner-form-wrap wow fadeInRight" data-wow-delay="1.1s" data-wow-duration="1.3s">
                                ...
                                <img src="assets/images/banner/exam-management.webp" alt="image" class="rs-banner-bg-img">
                                        ...
                                        <div class="rs-form-row">
                                            <div class="rs-form-group">
                                                <select name="service">
                                                    ...
                                                    <option value="center_mgmt">Center Management</option>
                                                    <option value="logistics">Logistics & Distribution</option>
                                                    <option value="verification">Candidate Verification</option>
                                                    <option value="processing">Result Processing</option>
                                                </select>
                                            </div>
                                            <div class="rs-form-group">
                                                <select name="sub_service">
                                                    <option value="" disabled selected>Test Methodology</option>
                                                    <option value="online">Online CBT</option>
                                                    <option value="offline">Offline PBT</option>
                                                    <option value="omr">OMR Scanning</option>
                                ...
                                <div class="rs-banner-feature">
                                    <div class="rs-banner-feature-inner">
                                        <div class="rs-banner-feature-thumb">
                                            <img src="assets/images/banner/exam-management.webp" alt="image">
                                        </div>
                                        <div class="rs-banner-feature-content">
                                            <h5 class="rs-banner-feature-title">Seamless Exam Admin</h5>
                                            <p class="rs-banner-feature-desc">End-to-end secure management for offline and online competitive examinations.</p>
                    ...
                    <div class="col-xl-9 col-lg-10">
                        <div class="section-title-wrapper text-center section-title-space">
                            <span class="section-subtitle">
                                Integrated Exam Management
                            </span>
                            <h2 class="section-title rs-split-text-enable split-in-left mb-15">Seamless Examination Lifecycle
                            </h2>
                            <p class="section-desc">Streamline your institutional and corporate examinations with our end-to-end management solutions, ensuring integrity and efficiency at every step.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-feature-wrapper wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <?php
                            $features = [
                                ["thumb" => "05", "title" => "Center Management"],
                                ["thumb" => "06", "title" => "Logistics & Distribution"],
                                ["thumb" => "07", "title" => "Candidate Verification"],
                                ["thumb" => "08", "title" => "Result Processing"],
                                ["thumb" => "09", "title" => "Data Security"],
                                ["thumb" => "13", "title" => "Invigilation Services"],
                                ["thumb" => "14", "title" => "Online Examination"],
                                ["thumb" => "10", "title" => "Offline Testing"],
                                ["thumb" => "15", "title" => "Paper-based exams"],
                                ["thumb" => "16", "title" => "Secure Vaulting"],
                                ["thumb" => "17", "title" => "OMR Scanning"],
                                ["thumb" => "11", "title" => "Public Sector Exams"],
                                ["thumb" => "12", "title" => "Corporate Testing"]
                            ];
                        ...
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-content-wrapper">
                                <div class="section-title-wrapper">
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left is-white mb-20">Your Trusted Partner in Large-Scale Testing</h2>
                                    <p class="section-desc is-white">ICEF India is a leading specialist in managing complex examination processes for academic, professional, and government bodies. We combine robust logistics with cutting-edge technology to deliver secure, scalable, and reliable testing solutions.</p>
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="rs-working-wrapper">
                            <div class="rs-working-content-wrapper">
                                <div class="section-title-wrapper">
                                    <span class="section-subtitle">
                                        Robust Examination Strategy
                                    </span>
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-20">Transforming local testing into national success</h2>
                                    <p class="rs-section-desc">Our strategic approach to exam management covers everything from center allocation and invigilation to result processing and data security. We help you maintain the highest standards of academic and professional transparency.</p>
                                </div>
