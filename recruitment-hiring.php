<?php $pageTitle = "Recruitment & Hiring";
                        ...
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content">
                                ...
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">
                                    End-to-End Executive Recruitment & Talent Acquisition
                                </h1>
                                <span class="rs-banner-line"></span>
                                <p class="rs-banner-desc wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">Optimize your hiring lifecycle with our expert recruitment solutions that focus on matching technical skills with organizational culture.</p>
                            ...
                            <div class="rs-banner-thumb rs-banner-form-wrap wow fadeInRight" data-wow-delay="1.1s" data-wow-duration="1.3s">
                                ...
                                <img src="assets/images/banner/recruitment.webp" alt="image" class="rs-banner-bg-img">
                                <div class="rs-banner-contact-form">
                                    ...
                                    <form action="#" method="POST" class="rs-contact-form-banner">
                                        ...
                                        <div class="rs-form-row">
                                            <div class="rs-form-group">
                                                <select name="service">
                                                    <option value="" disabled selected>Hiring Need</option>
                                                    <option value="direct_hire">Direct Hire</option>
                                                    <option value="executive">Executive Search</option>
                                                    <option value="bulk">Bulk Recruitment</option>
                                                    <option value="lateral">Lateral Hiring</option>
                                                </select>
                                            </div>
                                            <div class="rs-form-group">
                                                <select name="sub_service">
                                                    ...
                                                    <option value="mid">Mid-Management</option>
                                                    <option value="senior">Senior Leadership</option>
                                                    <option value="cxo">CXO/Board Level</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="rs-form-row">
                                ...
                                <div class="rs-banner-feature">
                                    <div class="rs-banner-feature-inner">
                                        <div class="rs-banner-feature-thumb">
                                            <img src="assets/images/banner/recruitment.webp" alt="image">
                                        </div>
                                        <div class="rs-banner-feature-content">
                                            <h5 class="rs-banner-feature-title">Expert Headhunting</h5>
                                            <p class="rs-banner-feature-desc">Strategic talent acquisition solutions for direct hires and executive leadership roles.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9 col-lg-10">
                        <div class="section-title-wrapper text-center section-title-space">
                            ...
                            <h2 class="section-title rs-split-text-enable split-in-left mb-15">Find Your Next Industry Leader
                            </h2>
                            <p class="section-desc">We bridge the gap between top talent and leading organizations. Our recruitment experts ensure a seamless hiring journey that matches skills with your corporate vision.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-feature-wrapper wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <?php
                            $features = [
                                ["thumb" => "05", "title" => "Direct Hire"],
                                ["thumb" => "06", "title" => "RPO Services"],
                                ["thumb" => "07", "title" => "Volume Hiring"],
                                ["thumb" => "08", "title" => "Bulk Recruitment"],
                                ["thumb" => "09", "title" => "Staff Augmentation"],
                                ["thumb" => "13", "title" => "Lateral Hiring"],
                                ["thumb" => "14", "title" => "Talent Sourcing"],
                                ["thumb" => "10", "title" => "Onboarding Support"],
                                ["thumb" => "15", "title" => "Credentialing"],
                                ["thumb" => "16", "title" => "Skill Assessment"],
                                ["thumb" => "17", "title" => "Vendor Management"],
                                ["thumb" => "11", "title" => "Diversity Hiring"],
                                ["thumb" => "12", "title" => "Global Recruitment"]
                            ];
                        ...
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-content-wrapper">
                                <div class="section-title-wrapper">
                                    ...
                                    <h2 class="section-title rs-split-text-enable split-in-left is-white mb-20">Your Trusted Partner in Identifying World-Class Talent</h2>
                                    <p class="section-desc is-white">ICEF India specializes in finding the perfect fit for your organizational needs. With a deep understanding of market trends and a vast network of professionals, we streamline your recruitment process for maximum efficiency.</p>
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="rs-working-wrapper">
                            <div class="rs-working-content-wrapper">
                                <div class="section-title-wrapper">
                                    <span class="section-subtitle">
                                        Innovative Hiring Strategy
                                    </span>
                                    <h2 class="section-title rs-split-text-enable split-in-left mb-20">Transforming potential into organizational success</h2>
                                    <p class="rs-section-desc">Our recruitment consulting focuses on identifying the right cultural and technical fit. We provide end-to-end support, from initial job profiling to final onboarding, ensuring a consistent and professional hiring experience.</p>
                                </div>
