...
<body class="rs-smoother-yes">
    ...
    <main>
                        ...
                        <div class="rs-banner-wrapper">
                            <div class="rs-banner-content-wrapper">
                                ...
                                <h1 class="rs-banner-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s" >
                                    Scalable IT Infrastructure &amp; <br><span id="demo-typed-text" style="color:#AB052D;"></span><span class="demo-typed-cursor" style="color:#AB052D; font-weight:300;">|</span>
                                </h1>
        ...
        <script>
        (function() {
            var text = "Emerging Tech Integration";
